      ...
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="mb-10">
          <a
            ...
            className="inline-flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm"
          >
            <FileText size={16} />
        ...
        <div className="max-w-3xl space-y-0">
          ...
          <div className="bg-gray-200 border border-gray-300 p-6 mb-10">
            ...
            <ul className="space-y-2">
              <li><button onClick={() => scrollTo('what-is-ot')} className="text-[#D61F69] underline hover:no-underline text-left">What is occupational therapy?</button></li>
              <li><button onClick={() => scrollTo('who-can-get-help')} className="text-[#D61F69] underline hover:no-underline text-left">Who can get help?</button></li>
              <li><button onClick={() => scrollTo('what-we-help')} className="text-[#D61F69] underline hover:no-underline text-left">What can we help with?</button></li>
              <li><button onClick={() => scrollTo('home-adaptations')} className="text-[#D61F69] underline hover:no-underline text-left">Home adaptations</button></li>
              <li><button onClick={() => scrollTo('cannot-help')} className="text-[#D61F69] underline hover:no-underline text-left">What we cannot help with</button></li>
              <li><button onClick={() => scrollTo('how-to-ask')} className="text-[#D61F69] underline hover:no-underline text-left">How to ask for an assessment</button></li>
              <li><button onClick={() => scrollTo('what-happens')} className="text-[#D61F69] underline hover:no-underline text-left">What happens next</button></li>
              <li><button onClick={() => scrollTo('costs')} className="text-[#D61F69] underline hover:no-underline text-left">Do I need to pay?</button></li>
          ...
          <div id="what-is-ot" className="pb-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What is occupational therapy?</h2>
          ...
          <div id="who-can-get-help" className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Who can get help?</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="what-we-help" className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What can we help with?</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="home-adaptations" className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Home adaptations</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="cannot-help" className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What we cannot help with</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="how-to-ask" className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">How to ask for an assessment</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="what-happens" className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What happens next</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="costs" className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Do I need to pay?</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="related" className="pt-10">
            ...
            <ul className="space-y-2 mb-6">
              <li>
                <a href="#/adult-social-care/live-independently-at-home/equipment-and-assistive-technology" className="text-[#D61F69] underline hover:no-underline">
              ...
              <li>
                <a href="https://www.gov.uk/disabled-facilities-grants" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline inline-flex items-center gap-1">
                  Disabled Facilities Grant
                  <ExternalLink size={14} />
                </a>
              </li>

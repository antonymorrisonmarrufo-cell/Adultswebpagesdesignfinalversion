          ...
          <div className="max-w-3xl space-y-0">
            ...
            <div className="bg-gray-100 border border-gray-300 p-6 mb-10 shadow-inner">
              ...
              <ul className="space-y-2">
                <li><button onClick={() => scrollTo('why-falls')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Why falls happen</button></li>
                <li><button onClick={() => scrollTo('reduce-risk')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">How to reduce your risk of falling</button></li>
                <li><button onClick={() => scrollTo('activities')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Local activities and exercise</button></li>
                <li><button onClick={() => scrollTo('reablement')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">What reablement is</button></li>
                <li><button onClick={() => scrollTo('who-can-help')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Who reablement can help</button></li>
                <li><button onClick={() => scrollTo('how-to-get-support')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">How to get support</button></li>
            ...
            <div id="why-falls" className="pb-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Why falls happen</h2>
            ...
            <div id="reduce-risk" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">How to reduce your risk of falling</h2>
              <p className="text-gray-700 mb-4 font-semibold">
            ...
            <div id="activities" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Local activities and exercise</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-[#D61F69] font-bold underline hover:no-underline text-sm"
                >
                  <FileText size={16} />
            ...
            <div id="reablement" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">What reablement is</h2>
            ...
            <div id="who-can-help" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Who reablement can help</h2>
              <p className="text-gray-700 mb-4 font-semibold">
            ...
            <div id="how-to-get-support" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">How to get support</h2>
            ...
            <div id="related" className="pt-10">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#/adult-social-care/live-independently-at-home/keeping-safe-at-home" className="text-[#D61F69] font-bold underline hover:no-underline">

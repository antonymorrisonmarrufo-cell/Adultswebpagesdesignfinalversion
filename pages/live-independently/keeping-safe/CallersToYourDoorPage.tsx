    ...
    <>
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="max-w-3xl space-y-0">
          ...
          {/* Why this matters */}
          <div className="pb-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Why this matters</h2>
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Ways to protect yourself</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">If you decide to buy</h2>
            <p className="text-gray-700 mb-4">

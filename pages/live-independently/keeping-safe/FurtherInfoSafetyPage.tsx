    ...
    <>
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="max-w-3xl space-y-0">
          ...
          <div className="pb-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Trusted external support</h2>
            ...
            <div className="space-y-4">
              {externalLinks.map((link, index) => (
                <a
                  ...
                  className="flex items-start justify-between gap-4 bg-gray-200 border border-gray-300 px-5 py-4 hover:bg-white hover:border-[#D61F69] transition-colors group"
                >
                  <div>
                    <p className="font-semibold text-[#D61F69] group-hover:underline text-sm mb-1">{link.label}</p>
                    <p className="text-gray-600 text-sm">{link.description}</p>
                  </div>
                  <ExternalLink className="text-[#D61F69] flex-shrink-0 mt-0.5" size={18} />
                </a>
              ))}
            </div>
          </div>

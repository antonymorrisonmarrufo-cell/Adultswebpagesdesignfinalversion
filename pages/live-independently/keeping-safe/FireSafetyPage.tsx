    ...
    <>
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="max-w-3xl space-y-0">
          ...
          <div className="pb-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Preventing fires at home</h2>
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Get a free fire safety check</h2>
            <p className="text-gray-700 mb-4">

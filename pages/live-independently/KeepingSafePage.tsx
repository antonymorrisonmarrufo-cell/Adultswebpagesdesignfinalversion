            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#FADADD] flex items-center justify-center flex-shrink-0 group-hover:bg-[#D61F69] transition-colors">
                    <Icon className="text-[#D61F69] group-hover:text-white transition-colors" size={24} />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#D61F69] transition-colors">
                      {card.title}
                    </h3>
                  </div>
                  <ArrowRight className="text-[#D61F69] flex-shrink-0 mt-1" size={20} />
                </div>
              </a>
            );
          })}

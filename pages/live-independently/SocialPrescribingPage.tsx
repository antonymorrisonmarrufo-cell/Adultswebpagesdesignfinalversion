    ...
    <>
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="max-w-3xl space-y-0">
          ...
          <div className="pb-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What social prescribing is</h2>
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Who it can help</h2>
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What happens</h2>
            <p className="text-gray-700">

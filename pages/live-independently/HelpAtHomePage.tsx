          ...
          <div className="max-w-3xl space-y-0">
            ...
            <div className="bg-gray-100 border border-gray-300 p-6 mb-10 shadow-inner">
              ...
              <ul className="space-y-2">
                <li><button onClick={() => scrollTo('personal-care')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Help with personal care</button></li>
                <li><button onClick={() => scrollTo('meals')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Help with meals and food</button></li>
                <li><button onClick={() => scrollTo('housework')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Help with housework and home maintenance</button></li>
                <li><button onClick={() => scrollTo('everyday-tasks')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Help with everyday tasks at home</button></li>
                <li><button onClick={() => scrollTo('when-to-ask')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">When to ask us for support</button></li>
            ...
            <div id="personal-care" className="pb-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Help with personal care</h2>
            ...
            <div id="meals" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Help with meals and food</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <div id="housework" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Help with housework and home maintenance</h2>
            ...
            <div id="everyday-tasks" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Help with everyday tasks at home</h2>
              <p className="text-gray-700 mb-4 leading-relaxed font-semibold">
            ...
            <div id="when-to-ask" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">When to ask us for support</h2>
            ...
            <div id="related" className="pt-10">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#/adult-social-care/live-independently-at-home/equipment-and-assistive-technology" className="text-[#D61F69] font-bold underline hover:no-underline">

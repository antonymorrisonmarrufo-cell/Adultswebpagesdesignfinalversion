    ...
    <>
      <section className="bg-gray-200 py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Section heading */}
          <h2 className="text-3xl font-bold text-[#D61F69] mb-8">Ways we can help</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {primaryCards.map((card, index) => (
              ...
              >
                <h3 className="text-lg font-bold text-[#D61F69] mb-3 pr-12">{card.title}</h3>
                <p className="text-gray-700 text-sm mb-4 pr-12">{card.summary}</p>
                <div className="absolute bottom-6 left-6 right-16">
                  <span className="text-[#D61F69] text-sm font-semibold">{card.cta}</span>
                </div>
          ...
          {/* Secondary section */}
          <h2 className="text-2xl font-bold text-[#D61F69] mb-6">Other ways to stay well at home</h2>
          ...
          <div className="flex flex-col gap-6 mb-12 max-w-4xl">
            ...
            >
              <div className="flex-1 p-6 pr-4 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mt-2">
                  <span className="text-[#D61F69] text-sm font-semibold">Find out about Homeshare</span>
                  <div className="w-10 h-10 rounded-full bg-[#D61F69] flex items-center justify-center flex-shrink-0 ml-4">
                    <ArrowRight className="text-white" size={20} />
                  </div>
                </div>
              </div>
            ...
            >
              <div className="flex-1 p-6 pr-4 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mt-2">
                  <span className="text-[#D61F69] text-sm font-semibold">Find out about social prescribing</span>
                  <div className="w-10 h-10 rounded-full bg-[#D61F69] flex items-center justify-center flex-shrink-0 ml-4">
                    <ArrowRight className="text-white" size={20} />
                  </div>
                </div>
          ...
          <div className="bg-white border border-gray-300 p-8 mb-12 max-w-4xl shadow-sm">
            <h2 className="text-2xl font-bold text-[#D61F69] mb-4">For professionals</h2>
          ...
          <div className="border-t border-gray-300 pt-8 max-w-4xl">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#/adult-social-care/how-to-get-support" className="text-[#D61F69] underline hover:no-underline font-semibold">
                  How to get support
                </a>
              </li>
              <li>
                <a href="#/adult-social-care/paying-for-your-care" className="text-[#D61F69] underline hover:no-underline font-semibold">
                  Paying for your care
                </a>
              </li>
              <li>
                <a href="#/adult-social-care/protecting-adults-at-risk" className="text-[#D61F69] underline hover:no-underline font-semibold">

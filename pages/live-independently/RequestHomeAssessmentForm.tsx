    ...
    <div className="min-h-screen bg-gray-200">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="bg-white border border-gray-200 p-8 md:p-12 shadow-sm">
          ...
          <h1 className="text-[36px] text-[#00635C] mb-4 font-bold leading-tight">
          ...
          {/* Before you start */}
          <div className="bg-[#FADADD] border-l-4 border-[#D61F69] px-5 py-4 mb-10">
          ...
          <div className="mb-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What this form is for</h2>
            <p className="text-gray-700 mb-4">
              Use this form if you need help with:
            </p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-start gap-2 text-gray-700">
                <CheckCircle2 className="text-[#D61F69] flex-shrink-0 mt-0.5" size={20} />
          ...
          {/* What you will need */}
          <div className="mb-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What you will need</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              className="inline-flex items-center justify-center gap-3 bg-[#D61F69] text-white px-8 py-4 font-semibold hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69] focus-visible:ring-offset-2 text-lg"
            >
              Start form
              <ArrowRight size={20} />
            </button>

          ...
          <div className="max-w-3xl space-y-0">
            ...
            <div className="bg-white border border-gray-300 p-6 mb-10 shadow-sm">
              ...
              <ul className="space-y-2">
                <li><button onClick={() => scrollTo('what-equipment')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">What equipment can help with</button></li>
                <li><button onClick={() => scrollTo('get-yourself')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Get equipment yourself</button></li>
                <li><button onClick={() => scrollTo('provided-by-us')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">If equipment is provided by us</button></li>
                <li><button onClick={() => scrollTo('repairs')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Faulty equipment and repairs</button></li>
                <li><button onClick={() => scrollTo('returning')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Returning equipment</button></li>
                <li><button onClick={() => scrollTo('assessment')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">When to ask for an assessment</button></li>
                <li><button onClick={() => scrollTo('related')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Related help</button></li>
              </ul>
            </div>

            {/* What equipment can help with */}
            <div id="what-equipment" className="pb-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">What equipment can help with</h2>
            ...
            <div id="get-yourself" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Get equipment yourself</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-1">
                  <a
                    ...
                    className="text-[#D61F69] font-bold underline hover:no-underline inline-flex items-center gap-1 text-sm"
                  >
                    Living Made Easy
            ...
            <div id="provided-by-us" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">If equipment is provided by us</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <div id="repairs" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Faulty equipment and repairs</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div className="bg-white p-6 border border-gray-300 shadow-sm">
                ...
                <p className="text-gray-700">
                  Telephone: <a href="tel:02033738800" className="text-[#D61F69] font-bold underline hover:no-underline">0203 373 8800</a>
                </p>
              </div>
            </div>
            ...
            <div id="returning" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Returning equipment</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div className="bg-white p-6 border border-gray-300 shadow-sm">
                <p className="text-gray-700">
                  Current provider phone: <a href="tel:02033738800" className="text-[#D61F69] font-bold underline hover:no-underline">0203 373 8800</a>
                </p>
              </div>
            </div>
            ...
            <div id="assessment" className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">When to ask for an assessment</h2>
              <p className="text-gray-700 mb-4 font-semibold">
            ...
            <div id="related" className="pt-10">
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#/adult-social-care/live-independently-at-home/home-adaptations-and-occupational-therapy" className="text-[#D61F69] font-bold underline hover:no-underline">
                    Home adaptations and occupational therapy
                  </a>
                </li>
                <li>
                  <a href="#/adult-social-care/live-independently-at-home/help-at-home-and-personal-care" className="text-[#D61F69] font-bold underline hover:no-underline">
                    Help at home and personal care
                  </a>
                </li>
                <li>
                  <a href="#/adult-social-care/live-independently-at-home/falls-prevention-and-reablement" className="text-[#D61F69] font-bold underline hover:no-underline">

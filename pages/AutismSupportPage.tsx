  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl text-[#00635C] mb-3 font-bold leading-tight">Support for adults with autism</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <h2 className="text-[#D61F69] mb-6 font-bold">What is autism?</h2>
            ...
            <a
              ...
              className="inline-block bg-[#D61F69] text-white px-6 py-3 hover:bg-[#B01758] transition-colors mb-12 shadow-sm font-bold"
            >
              Read our Autism Strategy
            </a>

            {/* How to get help section */}
            <h2 className="text-[#D61F69] mb-6 font-bold">How to get help</h2>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white p-6 shadow-sm">
              <h2 className="text-[#D61F69] mb-4 font-bold">Related links:</h2>

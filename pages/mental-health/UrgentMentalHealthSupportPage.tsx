    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">In an emergency</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Mental Health Direct</h2>
        ...
        {/* Samaritans */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Samaritans</h2>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700">
            You can also email <a href="mailto:jo@samaritans.org" className="text-[#D61F69] hover:underline">jo@samaritans.org</a> if you prefer to write.
          </p>
        </section>

        {/* Shout */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Shout</h2>
          <p className="text-gray-700">
        ...
        {/* NHS 111 */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">NHS 111</h2>
          <p className="text-gray-700">
            If you need urgent medical advice but it is not an emergency, call <strong>111</strong>. You can also go to <a href="https://111.nhs.uk" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] hover:underline">111.nhs.uk</a>. NHS 111 can help you access mental health crisis services in your area.
          </p>
        </section>

        {/* If you are worried about someone else */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">If you are worried about someone else</h2>
          <p className="text-gray-700">

    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Waltham Forest Talking Therapies</h2>
        ...
        {/* What to expect */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What to expect</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Adult Early Help Service</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Through your GP */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Through your GP</h2>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700">
            If you are not registered with a GP, you can register using the NHS GP registration portal at <a href="https://www.nhs.uk" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] hover:underline">nhs.uk</a>.
          </p>
        </section>

        {/* Private therapy */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Private therapy</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Other places that offer therapy</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            <li>
              <a href="#/adult-social-care/mental-health-wellbeing/urgent-mental-health-support" className="text-[#D61F69] hover:underline">

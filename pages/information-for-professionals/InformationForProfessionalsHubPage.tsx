    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-6">Quick actions for professionals</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a 
              href="#/adult-social-care/information-for-professionals/how-to-make-referral"
              className="bg-[#D61F69] text-white py-4 px-6 text-center hover:bg-[#B51A5A] transition-colors flex items-center justify-center gap-2"
            >
        ...
        <section className="mb-8" id="contact">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-6">Key contacts</h2>

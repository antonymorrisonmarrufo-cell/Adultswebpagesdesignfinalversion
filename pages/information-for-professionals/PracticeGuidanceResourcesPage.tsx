    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Professional curiosity</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Self-neglect guidance</h2>
          <p className="text-gray-700 mb-6">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Mental capacity guidance</h2>
          <p className="text-gray-700 mb-6">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Making Safeguarding Personal</h2>
          <p className="text-gray-700 mb-6">
        ...
        {/* Pressure care */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Pressure care</h2>
          <p className="text-gray-700 mb-6">
        ...
        {/* Training */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Training</h2>
          <p className="text-gray-700 mb-6">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Spotlight bulletins and 7-minute briefings</h2>
          <p className="text-gray-700 mb-6">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Bitesize video guides — adults</h2>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#/adult-social-care/our-policies" className="text-[#D61F69] hover:underline">
                Our policies
              </a>
            </li>
          </ul>

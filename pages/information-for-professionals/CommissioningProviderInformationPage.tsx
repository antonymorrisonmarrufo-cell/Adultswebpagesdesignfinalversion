  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Current frameworks and contracts</h2>
        ...
        {/* Provider support */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Provider support</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-12 bg-gray-50 border border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Contact the Commissioning team</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#/adult-social-care/our-policies/market-sustainability-commissioning" className="text-[#D61F69] hover:underline">

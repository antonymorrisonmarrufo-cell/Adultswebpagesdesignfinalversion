export default function PlanningPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-5xl text-[#00635C] mb-6 font-bold leading-tight" id="top">Planning ahead and end of life care</h1>
      
      <p className="text-gray-700 max-w-4xl mb-12">
        It's helpful to put legal and care arrangements in place early.
      </p>

      <h2 className="text-[#D61F69] mb-8 font-bold" id="legal">Legal arrangements</h2>
      <ul className="list-disc list-inside space-y-3 text-gray-700 max-w-4xl mb-12">
        ...
        <li>
          <strong>Deputyship/Appointeeship</strong> – learn more on our <a href="#/adult-social-care/specialist-services/power-attorney-deputyship-and-appointeeship" className="text-[#D61F69] hover:underline">Power of attorney, deputyship and appointeeship</a> page.
        </li>
      </ul>

      <h2 className="text-[#D61F69] mb-8 font-bold" id="care">Care planning</h2>

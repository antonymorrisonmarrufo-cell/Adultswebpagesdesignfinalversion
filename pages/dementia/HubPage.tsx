...
export default function HubPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-5xl text-[#00635C] mb-6 font-bold leading-tight" id="top">Waltham Forest Dementia Hub</h1>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="offer">What the Hub offers</h2>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="contact">Where to find us</h2>
        ...
        <ul className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {relatedPages.map((page, index) => (
            <li key={index}>
              <a
                href={page.href}
                className="bg-[#D61F69] text-white p-6 flex items-center justify-between hover:bg-[#B51A5A] transition-colors"
              >

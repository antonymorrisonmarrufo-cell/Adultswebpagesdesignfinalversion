export default function CarersPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-5xl text-[#00635C] mb-6 font-bold leading-tight" id="top">Help for carers of people with dementia</h1>
      
      <p className="text-gray-700 max-w-4xl mb-12">
        Get emotional support, practical help and a break from caring.
      </p>

      <h2 className="text-[#D61F69] mb-8 font-bold" id="start">Where to start</h2>
      <ul className="list-disc list-inside space-y-3 text-gray-700 max-w-4xl mb-12">
        <li>
          <strong>Carers First:</strong> 0300 303 1555 • <a href="mailto:hello@carersfirst.org.uk" className="text-[#D61F69] hover:underline">hello@carersfirst.org.uk</a>
        </li>
        <li>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="local">Local offers for carers</h2>

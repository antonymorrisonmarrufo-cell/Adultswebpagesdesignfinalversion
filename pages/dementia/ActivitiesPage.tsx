export default function ActivitiesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-5xl text-[#00635C] mb-6 font-bold leading-tight" id="top">Activities and day support</h1>
      
      <p className="text-gray-700 max-w-4xl mb-12">
        Staying active, social and independent can help you feel better day to day.
      </p>

      <h2 className="text-[#D61F69] mb-8 font-bold" id="local">What's available locally</h2>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="join">How to join</h2>
      <p className="text-gray-700 max-w-4xl">
        Contact the <a href="#/adult-social-care/specialist-services/dementia/hub" className="text-[#D61F69] hover:underline">Dementia Hub</a> for timetables and eligibility. If you need transport or help to attend, mention this when you get in touch.
      </p>
      </div>
    </div>
  );

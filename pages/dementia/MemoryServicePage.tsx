export default function MemoryServicePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-5xl text-[#00635C] mb-6 font-bold leading-tight" id="top">NHS Memory Service (assessment and diagnosis)</h1>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="expect">What to expect</h2>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="refer">How to be referred</h2>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="after">After diagnosis</h2>
      <p className="text-gray-700 max-w-4xl">
        The <a href="#/adult-social-care/specialist-services/dementia/hub" className="text-[#D61F69] hover:underline">Dementia Hub</a> can link you to groups and community support. If daily tasks are difficult, ask Adult Social Care about equipment and adaptations.
      </p>
      </div>
    </div>
  );

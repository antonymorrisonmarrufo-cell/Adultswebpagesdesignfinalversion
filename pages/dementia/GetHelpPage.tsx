  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl text-[#00635C] mb-3 font-bold leading-tight">Get help with dementia</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <h2 className="text-[#D61F69] mb-6 font-bold text-2xl">What is dementia?</h2>
            ...
            <a
              href="#"
              className="inline-block bg-[#D61F69] text-white px-6 py-3 hover:bg-[#B01758] transition-colors mb-12 font-bold shadow-sm"
            >

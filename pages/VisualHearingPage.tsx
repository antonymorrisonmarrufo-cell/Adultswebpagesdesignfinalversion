  ...
  return (
    <div className="min-h-screen bg-gray-200">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl text-[#00635C] mb-3 font-bold leading-tight">Visual and hearing impairments</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <h2 className="text-[#D61F69] mb-6 font-bold text-2xl">What the Sensory Support Service offers</h2>
            ...
            <h2 className="text-[#D61F69] mb-6 font-bold text-2xl">Adaptations, equipment and technology to help you</h2>
              ...
              {telecareOpen && (
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <a
                      href="#/adult-social-care/live-independently-at-home/telecare-and-community-alarm"
                      className="inline-block bg-[#D61F69] text-white px-6 py-3 hover:bg-[#B01758] transition-colors font-bold shadow-sm"
                    >
            ...
            {/* How to get help */}
            <h2 className="text-[#D61F69] mb-6 font-bold text-2xl">How to get help</h2>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <a
                      ...
                      className="inline-block bg-[#D61F69] text-white px-6 py-3 hover:bg-[#B01758] transition-colors text-center font-bold shadow-sm"
                    >
            ...
            <h2 className="text-[#D61F69] mb-6 font-bold text-2xl">Help with getting around</h2>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white p-6 shadow-sm">
              <h2 className="text-[#D61F69] mb-4 font-bold text-xl">Related links:</h2>
        ...
        <h2 className="text-[#D61F69] mb-6 font-bold text-2xl">Related Pages</h2>

    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Who adult social care is for</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How eligibility works</h2>
        ...
        {/* What we look at */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What we look at</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What happens if you are eligible</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What happens if you are not eligible</h2>
          <p className="text-gray-700 mb-4">

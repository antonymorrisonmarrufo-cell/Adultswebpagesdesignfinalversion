export default function PowerOfAttorneyPage() {
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <h1 className="text-5xl text-[#00635C] mb-6 font-bold leading-tight" id="top">Power of attorney, deputyship and appointeeship</h1>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="options">Your options</h2>
      ...
      <h2 className="text-[#D61F69] mb-8 font-bold" id="advice">Get independent advice</h2>

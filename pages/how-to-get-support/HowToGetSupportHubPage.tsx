  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-8 md:py-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="bg-gray-50 p-6 border border-gray-200">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 bg-[#D61F69] text-white px-6 py-2 text-sm font-semibold hover:bg-[#B51A5A] transition-colors"
              >
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#D61F69] mb-6">The steps from first contact to support</h2>
        ...
        <section className="mb-12 bg-gray-200 p-8 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-lg font-bold text-[#D61F69] mb-2 pr-12">Check your situation online</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#D61F69] mb-2 pr-12">Contact us</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#D61F69] mb-2 pr-12">Request an assessment</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#D61F69] mb-2 pr-12">What happens during your assessment</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#D61F69] mb-2 pr-12">Getting your care and support plan</h3>
        ...
        <section className="mb-12 bg-gray-100 p-8 border border-gray-200">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Need help urgently?</h2>

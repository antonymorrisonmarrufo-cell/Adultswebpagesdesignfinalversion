    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How the assessment works</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What we will talk about</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What happens afterwards</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">If you are not eligible</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            <li>
              <a href="#/adult-social-care/how-to-get-support/getting-your-care-and-support-plan" className="text-[#D61F69] hover:underline">

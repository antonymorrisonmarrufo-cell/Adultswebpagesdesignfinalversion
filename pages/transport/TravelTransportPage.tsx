    ...
    <>
      <section className="bg-gray-200 py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Section heading */}
          <h2 className="text-[#D61F69] font-bold text-xl mb-8">Topics in this section</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {cards.map((card, i) => (
              ...
              >
                ...
                <div className="absolute right-5 bottom-5 w-10 h-10 rounded-full bg-[#D61F69] group-hover:bg-[#B51A5A] flex items-center justify-center transition-colors">

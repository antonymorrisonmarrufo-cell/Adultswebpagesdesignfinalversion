    ...
    <div className="space-y-3">
      {links.map((link, i) => (
        <a
          ...
          className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-semibold"
        >
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="flex-1 max-w-3xl space-y-0">
              ...
              <div id="public-transport" className="scroll-mt-6 pb-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Using public transport with a disability</h2>
                ...
                <div className="space-y-3">
                  <a href="https://tfl.gov.uk/transport-accessibility/wheelchair-access-and-avoiding-stairs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
                    <ArrowRight size={14} />TfL step-free access
                  </a>
                  <div className="pt-1">
                    <a href="https://tfl.gov.uk/modes/dlr/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
                      <ArrowRight size={14} />DLR
                    </a>
                  </div>
                  <div className="pt-1">
                    <a href="https://tfl.gov.uk/modes/trams/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
              ...
              <div id="discounts" className="scroll-mt-6 py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Travel discounts and passes</h2>
                ...
                <div className="space-y-3">
                  <a href="https://www.walthamforest.gov.uk/adult-social-care/help-getting-around/freedom-pass-older-people" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
                    <ArrowRight size={14} />Freedom Pass for older people
                  </a>
                  <div className="pt-1">
                    <a href="https://www.walthamforest.gov.uk/adult-social-care/help-getting-around/freedom-pass-disabled-people" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
                      <ArrowRight size={14} />Freedom Pass for disabled people
                    </a>
                  </div>
                  <div className="pt-1">
                    <a href="https://www.disabledpersons-railcard.co.uk/are-you-eligible/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
              ...
              <div id="nhs-travel" className="scroll-mt-6 py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">NHS help with travel costs</h2>
                ...
                <div className="space-y-3">
                  <a href="https://www.nhs.uk/nhs-services/help-with-health-costs/healthcare-travel-costs-scheme-htcs/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
                    <ArrowRight size={14} />Healthcare Travel Costs Scheme
                  </a>
                  <div className="pt-1">
                    <a href="https://www.nhsbsa.nhs.uk/nhs-low-income-scheme" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-bold">
              ...
              <div id="community" className="scroll-mt-6 py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Community transport schemes</h2>
              ...
              <div id="cars" className="scroll-mt-6 py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Cars, parking and Motability</h2>
                <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              <div id="related" className="scroll-mt-6 py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Related links</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {relatedLinks.map((link, i) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group flex items-center justify-between gap-4 border border-gray-300 bg-white p-4 hover:shadow-md hover:border-[#D61F69] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69] shadow-sm"
                    >
                      <span className="text-gray-900 text-sm font-bold group-hover:text-[#D61F69] transition-colors">{link.label}</span>
                      <div className="w-8 h-8 rounded-full bg-[#D61F69] flex items-center justify-center flex-shrink-0 group-hover:bg-[#B51A5A] transition-colors shadow-sm">

      ...
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="bg-white border border-gray-300 p-8 md:p-12 shadow-sm max-w-4xl">
          ...
          <div className="max-w-3xl space-y-0">
            ...
            <div className="pb-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Which organisations can apply?</h2>
              ...
              <div className="bg-[#FADADD] border-l-4 border-[#D61F69] px-5 py-4 mb-6 shadow-sm">
              ...
              <div className="bg-white border border-gray-300 p-6 space-y-4 shadow-sm">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-700">
                  ...
                  <span className="font-semibold text-gray-900">
                    Telephone:{' '}
                    <a href="tel:02084963130" className="text-[#D61F69] underline hover:no-underline font-bold">
                      020 8496 3130
                    </a>
                  </span>
                </div>

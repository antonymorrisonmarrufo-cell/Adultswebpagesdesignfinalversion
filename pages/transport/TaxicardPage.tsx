      ...
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="bg-white border border-gray-300 p-8 md:p-12 shadow-sm max-w-4xl">
          ...
          <div className="max-w-3xl mt-6 space-y-0">
            ...
            {/* Double swiping */}
            <div className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Double swiping</h2>
            ...
            {/* How to apply */}
            <div className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">How to apply for a Taxicard</h2>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 bg-[#D61F69] text-white px-8 py-3 font-bold hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69] focus-visible:ring-offset-2 mb-6 shadow-sm"
              >
            ...
            <div className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Replacing a lost Taxicard</h2>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 border border-gray-400 bg-white px-5 py-4 hover:bg-gray-50 hover:border-[#D61F69] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69] group shadow-sm"
              >
                <FileText className="text-[#D61F69] flex-shrink-0" size={24} />
                <span className="text-gray-900 font-bold text-sm group-hover:text-[#D61F69] transition-colors">
                  Taxicard replacement form (PDF)
                </span>
                <ArrowRight className="text-[#D61F69] ml-8" size={20} />
              </a>
            </div>
            ...
            <div className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Contacting the Taxicard service</h2>
              <p className="text-gray-700 mb-6 leading-relaxed">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#D61F69] underline hover:no-underline font-bold"
                >
                  London Councils
                </a>{' '}
            ...
            {/* Related links */}
            <div className="py-10">
              <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Related information</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {relatedLinks.map((link, i) => (
                  ...
                  >
                    <span className="text-gray-900 text-sm font-bold group-hover:text-[#D61F69] transition-colors">{link.title}</span>

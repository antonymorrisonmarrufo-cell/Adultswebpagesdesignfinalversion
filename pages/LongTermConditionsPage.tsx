  ...
  return (
    <div className="min-h-screen bg-gray-200">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl text-[#00635C] mb-6 font-bold leading-tight" id="top">Long‑term conditions</h1>
        ...
        <div className="bg-white border-2 border-gray-300 p-8 mb-12 shadow-sm max-w-4xl">
          <h2 className="text-[#D61F69] mb-8 font-bold text-2xl" id="support">Support you can get</h2>
        ...
        <div className="bg-white border-2 border-gray-300 p-8 mb-12 shadow-sm max-w-4xl">
          <h2 className="text-[#D61F69] mb-8 font-bold text-2xl" id="ask">Ask for help</h2>

        ...
        <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
          ...
          <div className="bg-white border border-gray-300 p-8 md:p-12 shadow-sm max-w-4xl">
            ...
            <div className="max-w-3xl space-y-12">
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Health and GP information</h2>
                
                <div className="space-y-6">
                  <div className="border-l-4 border-[#D61F69] pl-6 py-2">
                    <a
                      href="https://www.walthamforest.gov.uk/sites/default/files/2022-03/EASY%20READ%20Annual%20health%20checks.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-start gap-3 text-[#D61F69] font-bold hover:underline text-lg mb-2"
                    >
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Transition and preparing for adulthood</h2>
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Safety and safeguarding</h2>
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">More specialist resources</h2>

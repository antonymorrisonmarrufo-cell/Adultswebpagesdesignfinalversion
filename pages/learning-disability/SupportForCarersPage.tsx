            ...
            <div className="max-w-3xl space-y-0">
              ...
              <div className="bg-gray-100 border border-gray-300 p-6 mb-10 shadow-inner">
                ...
                <ul className="space-y-2">
                  <li><button onClick={() => scrollTo('what-support')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">What support carers can get</button></li>
                  <li><button onClick={() => scrollTo('carers-assessments')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Carers assessments</button></li>
                  <li><button onClick={() => scrollTo('practical-emotional')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Practical and emotional support</button></li>
                  <li><button onClick={() => scrollTo('carers-first')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Carers First</button></li>
                  <li><button onClick={() => scrollTo('young-carers')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Young carers</button></li>
              ...
              <div id="what-support" className="pb-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">What support carers can get</h2>
              ...
              <div id="carers-assessments" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Carers assessments</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#D61F69] font-bold underline hover:no-underline"
                >
                  Adult carers
                </a>
              </div>
              ...
              <div id="practical-emotional" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Practical and emotional support</h2>
                <p className="text-gray-700 mb-4 font-semibold">
              ...
              <div id="carers-first" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Carers First</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div id="young-carers" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Young carers</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div id="related" className="pt-10">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="https://www.walthamforest.gov.uk/adult-social-care/being-carer/adult-carers" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] font-bold underline hover:no-underline">
                      Adult carers
                    </a>
                  </li>
                  <li>
                    <a href="https://www.walthamforest.gov.uk/adult-social-care/being-carer" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] font-bold underline hover:no-underline">
                      Being a carer
                    </a>
                  </li>
                  <li>
                    <a href="#/adult-social-care/learning-disability-support/ask-for-support" className="text-[#D61F69] font-bold underline hover:no-underline">

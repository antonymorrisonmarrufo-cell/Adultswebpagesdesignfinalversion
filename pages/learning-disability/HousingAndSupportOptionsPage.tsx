        ...
        <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
          ...
          <div className="bg-white border border-gray-300 p-8 md:p-12 shadow-sm max-w-4xl">
            ...
            <div className="max-w-3xl space-y-12">
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Types of housing and support</h2>
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">How to get housing support</h2>
                
                <div className="space-y-4">
                  <div className="border-l-4 border-[#D61F69] pl-6 py-3">
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">For young people preparing for adulthood</h2>
                
                <div className="bg-[#F0F9FF] border-l-4 border-[#D61F69] p-6">
              ...
              {/* Who can help */}
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Who can help</h2>
                
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-3">Community Learning Disability Team</h3>
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-3">Housing Options Team</h3>
                    <p className="text-gray-700 text-sm mb-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#D61F69] font-bold hover:underline text-sm"
                    >
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-3">Advocacy services</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-3">Your family and carers</h3>
                    <p className="text-gray-700 text-sm">

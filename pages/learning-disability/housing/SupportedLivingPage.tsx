            ...
            <div className="max-w-3xl space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Daily living tasks</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Managing money</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Community access</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Health and wellbeing</h3>
                    <p className="text-gray-700 text-sm">

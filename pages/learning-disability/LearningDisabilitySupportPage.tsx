      ...
      <div className="min-h-screen bg-white">
        <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
          ...
          <div className="bg-white border border-gray-300 p-8 md:p-12 shadow-sm max-w-4xl">
            {/* H1 */}
            <h1 className="text-5xl text-[#00635C] mb-2 font-bold leading-tight">
            ...
            <div className="mb-10">
              <a
                ...
                className="border-2 border-[#D61F69] bg-white p-6 pr-20 hover:shadow-md transition-shadow relative block"
              >
                <h2 className="text-xl font-bold text-[#D61F69] mb-3 pr-4">Professional referral</h2>
            ...
            <div className="max-w-3xl space-y-12">
              {/* How we can help */}
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">How we can help</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    <h3 className="text-[#D61F69] font-bold text-lg mb-3 pr-12">
                      Ask for learning disability support
                    </h3>
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Is this the right service?</h2>
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">What support is available?</h2>
                
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Assessment and care planning</h3>
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Health support and therapies</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Staying healthy</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Day opportunities and community life</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Support for carers</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#D61F69] font-bold text-lg mb-2">Preparing for adulthood</h3>
                    <p className="text-gray-700 text-sm">
              ...
              <section>
                ...
                <div className="bg-[#FFF0F7] border-l-4 border-[#D61F69] p-6">
                  <p className="text-gray-900 mb-3">
                    If you need urgent social care help outside normal working hours, call <a href="tel:02084963130" className="text-[#D61F69] font-bold underline hover:no-underline">020 8496 3130</a>.
                  </p>
                  <p className="text-gray-900 mb-3">
              ...
              <section>
                <h2 className="text-[#D61F69] font-bold text-2xl mb-6">Related support</h2>

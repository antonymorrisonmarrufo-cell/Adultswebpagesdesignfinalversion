            ...
            <div className="max-w-3xl space-y-0">
              ...
              <div className="bg-gray-100 border border-gray-300 p-6 mb-10 shadow-inner">
                ...
                <ul className="space-y-2">
                  <li><button onClick={() => scrollTo('when-planning')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">When planning should start</button></li>
                  <li><button onClick={() => scrollTo('before-18')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">What should happen before 18</button></li>
                  <li><button onClick={() => scrollTo('education-work')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Education, work and training</button></li>
                  <li><button onClick={() => scrollTo('health-transition')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Health transition</button></li>
                  <li><button onClick={() => scrollTo('housing')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Housing and independence</button></li>
                  <li><button onClick={() => scrollTo('useful-links')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Useful links and guides</button></li>
                </ul>
              </div>

              {/* When planning should start */}
              <div id="when-planning" className="pb-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">When planning should start</h2>
              ...
              <div id="before-18" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">What should happen before 18</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block text-[#D61F69] font-bold underline hover:no-underline"
                  >
              ...
              <div id="education-work" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Education, work and training</h2>
                <p className="text-gray-700 mb-4 font-semibold">
              ...
              <div id="health-transition" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Health transition</h2>
                <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              <div id="housing" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Housing and independence</h2>
                <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              <div id="useful-links" className="pt-10">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-[#D61F69] font-bold underline hover:no-underline"
                  >
                    Preparing for adulthood

        ...
        <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
          ...
          <div className="bg-white border border-gray-300 p-8 md:p-12 shadow-sm max-w-4xl">
            ...
            <div className="mb-10 flex flex-wrap gap-4">
              <button
                onClick={() => alert('Professional referral form would be integrated here')}
            ...
            <div className="max-w-3xl space-y-0">
              ...
              <div className="bg-gray-100 border border-gray-300 p-6 mb-10 shadow-inner">
                ...
                <ul className="space-y-2">
                  <li><button onClick={() => scrollTo('who-should-use')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">Who should use this route</button></li>
                  <li><button onClick={() => scrollTo('what-information')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">What information to include</button></li>
                  <li><button onClick={() => scrollTo('what-happens')} className="text-[#D61F69] font-bold underline hover:no-underline text-left">What happens next</button></li>
              ...
              <div id="who-should-use" className="pb-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">Who should use this route</h2>
              ...
              <div id="what-information" className="py-10">
                <h2 className="text-[#D61F69] font-bold text-2xl mb-4">What information to include</h2>
              ...
              <div id="urgent-help" className="pt-10">
                ...
                <p className="text-gray-900 mb-3">
                  For urgent social care issues outside normal working hours, call <a href="tel:02084963130" className="text-[#D61F69] font-bold underline hover:no-underline">020 8496 3130</a>.
                </p>
                <p className="text-gray-900 mb-3">

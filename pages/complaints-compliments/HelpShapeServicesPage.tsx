    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How you can get involved</h2>
        ...
        {/* Who we work with */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Who we work with</h2>
          <p className="text-gray-700 mb-4">
            We bring together:
          </p>
        ...
        {/* What is involved */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What is involved</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Reward and recognition</h2>
          <p className="text-gray-700">
        ...
        {/* How to get involved */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How to get involved</h2>
          <p className="text-gray-700 mb-4">
            If you are interested, contact the Voice and Influence Team:
          </p>
          <div className="border-l-4 border-[#D61F69] pl-4 mb-4">
            <p className="font-bold text-gray-900 mb-1 flex items-center gap-2">
              <Mail size={18} className="text-[#D61F69]" />
              Email:
            </p>
            <p className="text-gray-700">
              <a href="mailto:voiceandinfluence@walthamforest.gov.uk" className="text-[#D61F69] hover:underline">

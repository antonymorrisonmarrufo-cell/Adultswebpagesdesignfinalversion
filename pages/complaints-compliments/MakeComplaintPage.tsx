    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What you can complain about</h2>
        ...
        {/* Who can complain */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Who can complain</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Time limit */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Time limit</h2>
          <p className="text-gray-700">
        ...
        {/* How to complain */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How to complain</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What happens after you complain</h2>
          <p className="text-gray-700 mb-4">
          ...
          <div className="space-y-4">
            <div className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#D61F69] text-white flex items-center justify-center font-bold text-sm">
                1
              </div>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">If you are not satisfied with the outcome</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            <li>
              <a href="#/adult-social-care/complaints-compliments/independent-help-and-advocacy" className="text-[#D61F69] hover:underline">
                Independent help and advocacy
              </a>
            </li>
            <li>
              <a href="#/adult-social-care/complaints-compliments/send-us-a-compliment" className="text-[#D61F69] hover:underline">

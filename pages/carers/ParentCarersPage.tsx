  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Parent carers</h1>
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <ul className="space-y-2">
            <li><a href="#who-are" className="text-[#D61F69] underline hover:no-underline">Who parent carers are</a></li>
            <li><a href="#your-rights" className="text-[#D61F69] underline hover:no-underline">Your rights</a></li>
            <li><a href="#assessment-support" className="text-[#D61F69] underline hover:no-underline">Assessments and support</a></li>
            <li><a href="#local-groups" className="text-[#D61F69] underline hover:no-underline">Local groups and services</a></li>
            <li><a href="#send-help" className="text-[#D61F69] underline hover:no-underline">Related SEND help</a></li>
          </ul>
        </div>
        ...
        <div className="prose max-w-none">
          ...
          <div id="who-are" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Who parent carers are</h2>
          ...
          <div id="your-rights" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Your rights</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="assessment-support" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Assessments and support</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="local-groups" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Local groups and services</h2>
            ...
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Carers First</h3>
              <p className="text-gray-700 mb-4">
          ...
          <div id="send-help" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Related SEND help</h2>
            <p className="text-gray-700 mb-4">
              If your child has special educational needs or disabilities, you may also need:
            </p>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-[#D61F69] underline hover:no-underline">Education, Health and Care Plans (EHCPs)</a>
              </li>
              <li>
                <a href="#" className="text-[#D61F69] underline hover:no-underline">SEND support and services</a>
              </li>
              <li>
                <a href="#" className="text-[#D61F69] underline hover:no-underline">Short breaks for disabled children</a>
              </li>
              <li>
                <a href="#" className="text-[#D61F69] underline hover:no-underline">Transition to adult services</a>
              </li>
            </ul>
          </div>

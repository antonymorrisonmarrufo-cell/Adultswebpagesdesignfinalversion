    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
              ...
              <div key={index} className="bg-white border-2 border-gray-200 p-6 rounded-lg hover:border-[#EF3688] transition-colors">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  ...
                  <a 
                    ...
                    className="flex items-center gap-2 bg-[#EF3688] text-white px-6 py-3 rounded-lg hover:bg-[#D61F69] transition-colors whitespace-nowrap"
                  >
        ...
        <section className="my-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border-2 border-[#EF3688] p-6 rounded-lg flex flex-col justify-between">
              ...
              <button className="flex items-center gap-2 bg-[#EF3688] text-white px-6 py-3 rounded-lg hover:bg-[#D61F69] transition-colors w-fit">
        ...
        <section className="mt-12 bg-[#FFF0F7] p-8 rounded-lg">
          ...
          <a href="#" className="inline-block bg-[#EF3688] text-white px-6 py-3 rounded-lg hover:bg-[#D61F69] transition-colors">

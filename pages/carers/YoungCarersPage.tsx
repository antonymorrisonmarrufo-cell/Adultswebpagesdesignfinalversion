  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Young carers</h1>
        ...
        <div className="bg-[#FFF0F7] border-l-4 border-[#D61F69] p-6 mb-8">
          <h2 className="font-bold text-[#D61F69] text-xl mb-3">Your safety matters</h2>
          <p className="text-gray-900 mb-3">
            If you feel unsafe or too much is being asked of you, tell a trusted adult straight away. 
          </p>
          <p className="text-gray-900 mb-3">
            You can also call <strong>Childline</strong> on <a href="tel:08001111" className="text-[#D61F69] font-bold hover:underline">0800 1111</a> any time, day or night.
          </p>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <ul className="space-y-2">
            <li><a href="#who-are" className="text-[#D61F69] underline hover:no-underline">Who young carers are</a></li>
            <li><a href="#signs" className="text-[#D61F69] underline hover:no-underline">Signs someone may be a young carer</a></li>
            <li><a href="#support" className="text-[#D61F69] underline hover:no-underline">How we can support</a></li>
            <li><a href="#assessment" className="text-[#D61F69] underline hover:no-underline">Young carers assessment</a></li>
            <li><a href="#what-helps" className="text-[#D61F69] underline hover:no-underline">What young carers tell us helps most</a></li>
            <li><a href="#activities" className="text-[#D61F69] underline hover:no-underline">Activities and breaks</a></li>
            <li><a href="#school" className="text-[#D61F69] underline hover:no-underline">School support</a></li>
            <li><a href="#referral" className="text-[#D61F69] underline hover:no-underline">How to make a referral</a></li>
          </ul>
        </div>
        ...
        <div className="prose max-w-none">
          ...
          <div id="who-are" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Who young carers are</h2>
          ...
          <div id="signs" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Signs someone may be a young carer</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="support" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">How we can support</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="assessment" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Young carers assessment</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="what-helps" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">What young carers tell us helps most</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="activities" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Activities and breaks</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="school" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">School support</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="referral" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">How to make a referral</h2>
            <p className="text-gray-700 mb-4">

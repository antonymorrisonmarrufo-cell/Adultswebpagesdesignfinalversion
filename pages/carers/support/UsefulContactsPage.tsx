  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Useful contacts for carers</h1>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#D61F69] mb-6">Filter contacts</h2>
                ...
                <button
                  ...
                  className={`px-4 py-2 text-sm font-semibold transition-colors ${
                    selectedFilters.includes(tag)
                      ? 'bg-[#D61F69] text-white'
                      : 'bg-white border-2 border-gray-300 text-gray-700 hover:border-[#D61F69]'
                  }`}
                >
                  {tag}
                </button>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-3xl font-bold text-[#D61F69]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {filteredContacts.map((contact, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 p-6 hover:border-[#D61F69] transition-colors">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center gap-2">
                    <Phone className="w-4 h-4 text-[#D61F69]" />
                    <a href={`tel:${contact.phone.replace(/\s/g, '')}`} className="text-[#D61F69] font-semibold hover:underline">
                      {contact.phone}
                    </a>
                  </div>
                  ...
                  {contact.website && (
                    <p className="ml-6">
                      <a href={contact.website} target="_blank" rel="noopener noreferrer" className="text-[#D61F69] text-sm hover:underline">
                        Visit website
                      </a>
                    </p>
                  )}
                ...
                <div className="flex flex-wrap gap-2">
                  {contact.tags.map((tag, idx) => (
                    <span key={idx} className="inline-block px-3 py-1 text-xs bg-[#FFF0F7] text-[#D61F69] font-semibold">
                      {tag}
                    </span>
                  ))}
                </div>
        ...
        <div className="bg-[#FFF0F7] border-l-4 border-[#D61F69] p-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Can't find what you need?</h2>
          ...
          <a 
            href="tel:02084963130"
            className="inline-flex items-center gap-2 bg-[#D61F69] text-white px-6 py-3 hover:bg-[#b51858] transition-colors font-semibold"
          >

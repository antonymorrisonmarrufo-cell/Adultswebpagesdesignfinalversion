  ...
  return (
    <div className="border-2 border-gray-200">
      ...
      >
        ...
        <ChevronDown className={`w-5 h-5 text-[#D61F69] transition-transform flex-shrink-0 ml-4 ${isOpen ? 'rotate-180' : ''}`} />
      </button>
      {isOpen && (
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Financial support for carers</h1>
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <ul className="space-y-2">
            <li><a href="#carers-allowance" className="text-[#D61F69] underline hover:no-underline">Carer's Allowance</a></li>
            <li><a href="#carers-credit" className="text-[#D61F69] underline hover:no-underline">Carer's Credit</a></li>
            <li><a href="#council-tax" className="text-[#D61F69] underline hover:no-underline">Council Tax and other discounts</a></li>
            <li><a href="#grants" className="text-[#D61F69] underline hover:no-underline">Grants and extra help</a></li>
            <li><a href="#faqs" className="text-[#D61F69] underline hover:no-underline">Common questions about benefits</a></li>
            <li><a href="#get-advice" className="text-[#D61F69] underline hover:no-underline">Get advice</a></li>
          </ul>
        </div>
        ...
        <div className="prose max-w-none">
          ...
          <div id="carers-allowance" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Carer's Allowance</h2>
            ...
            <div className="bg-white border-l-4 border-[#D61F69] p-6 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              <a href="https://www.gov.uk/carers-allowance" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline font-bold">Find out more and apply for Carer's Allowance on GOV.UK</a>
            </p>
          </div>

          {/* Carer's Credit */}
          <div id="carers-credit" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Carer's Credit</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              <a href="https://www.gov.uk/carers-credit" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline font-bold">Find out more about Carer's Credit on GOV.UK</a>
            </p>
          </div>

          {/* Council Tax and other discounts */}
          <div id="council-tax" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Council Tax and other discounts</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-l-4 border-[#D61F69] p-6 mb-4">
              ...
              <a href="#" className="text-[#D61F69] underline hover:no-underline font-semibold">Apply for Council Tax Reduction</a>
            </div>
            <p className="text-gray-700 mb-4">
          ...
          <div id="grants" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Grants and extra help</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="faqs" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-6">Common questions about benefits</h2>
          ...
          <div id="get-advice" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Get advice</h2>
            <p className="text-gray-700 mb-4">
              If you are worried about money or not sure what you may be entitled to, free advice is available.
            </p>
            <div className="bg-[#FFF0F7] border-l-4 border-[#D61F69] p-6 mb-6">
              <h3 className="text-[#D61F69] font-bold text-lg mb-3">Benefits advice services</h3>
            ...
            <div className="bg-[#FFF0F7] border-l-4 border-[#D61F69] p-6 mb-4">
              <h3 className="text-[#D61F69] font-bold text-lg mb-3">Carers First</h3>
              ...
              <p className="text-gray-900">
                <a href="https://www.carersfirst.org.uk" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline font-bold">Visit Carers First</a>
              </p>
            </div>
            <p className="text-gray-700 mb-4">

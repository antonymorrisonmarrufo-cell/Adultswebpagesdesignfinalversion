  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Training and workshops for carers</h1>
        ...
        <div className="prose max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            <div className="bg-white border-2 border-gray-200 p-6">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Training and workshops</h3>
            ...
            <div className="bg-white border-2 border-gray-200 p-6">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">What's on guide</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-2 border-gray-200 p-6">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Peer support groups</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-2 border-gray-200 p-6">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Carers' forum</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div className="bg-white border-2 border-gray-200 p-6">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Online learning resources</h3>
              <p className="text-gray-700 mb-4">

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Your health and wellbeing</h1>
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <ul className="space-y-2">
            <li><a href="#mental-health" className="text-[#D61F69] underline hover:no-underline">Mental health support</a></li>
            <li><a href="#physical-health" className="text-[#D61F69] underline hover:no-underline">Physical health checks</a></li>
            <li><a href="#flu-jab" className="text-[#D61F69] underline hover:no-underline">Flu jab information</a></li>
            <li><a href="#local-support" className="text-[#D61F69] underline hover:no-underline">Related local support</a></li>
          </ul>
        </div>
        ...
        <div className="prose max-w-none">
          ...
          <div id="mental-health" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Mental health support</h2>
            ...
            <div className="bg-[#FFF0F7] border-l-4 border-[#D61F69] p-6 mb-4">
              <h3 className="text-[#D61F69] font-bold text-lg mb-3">Get help</h3>
              <ul className="space-y-2">
          ...
          <div id="physical-health" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Physical health checks</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="flu-jab" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Flu jab information</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="local-support" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Related local support</h2>
            <ul className="space-y-2">
              <li>
                <a href="https://www.carersfirst.org.uk" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline">Carers First – wellbeing support and counselling</a>
              </li>
              <li>
                <a href="#/adult-social-care/being-carer/support-for-carers/local-groups-and-services" className="text-[#D61F69] underline hover:no-underline">Local groups and services</a>
              </li>
              <li>

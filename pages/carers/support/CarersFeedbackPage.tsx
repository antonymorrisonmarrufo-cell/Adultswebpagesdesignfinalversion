  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Carers' feedback and testimonials</h1>
        ...
        <div className="prose max-w-none">
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">What carers have said</h2>
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">How feedback shapes services</h2>
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Tell us what would help</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Join the user research group</h2>
            <p className="text-gray-700 mb-4">

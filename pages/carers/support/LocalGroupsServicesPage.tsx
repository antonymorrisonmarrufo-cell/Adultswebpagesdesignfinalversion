  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Local groups and services</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-white border-2 border-gray-200 p-6">
            ...
            <a href="#/adult-social-care/being-carer/young-carers" className="text-[#D61F69] underline hover:no-underline font-bold">Find out about young carers support</a>
          </div>
          ...
          <div className="bg-white border-2 border-gray-200 p-6">
            ...
            <a href="#/adult-social-care/being-carer/parent-carers" className="text-[#D61F69] underline hover:no-underline font-bold">Find out about parent carer support</a>
          </div>

          <div className="bg-white border-2 border-gray-200 p-6">
            <h3 className="text-xl font-bold text-[#D61F69] mb-3">Community Directory</h3>
            <p className="text-gray-700 mb-4">
              Search for local groups, activities and services across Waltham Forest.
            </p>
            <a href="#" className="text-[#D61F69] underline hover:no-underline font-bold">Search the community directory</a>
          </div>

          <div className="bg-white border-2 border-gray-200 p-6">
            <h3 className="text-xl font-bold text-[#D61F69] mb-3">Mental health and wellbeing hubs</h3>
            <p className="text-gray-700 mb-4">
              Local mental health support and wellbeing services available in the borough.
            </p>
            <a href="#" className="text-[#D61F69] underline hover:no-underline font-bold">Find mental health support</a>
          </div>

          <div className="bg-white border-2 border-gray-200 p-6">
            <h3 className="text-xl font-bold text-[#D61F69] mb-3">Age UK Waltham Forest</h3>
            <p className="text-gray-700 mb-4">
              Support for older people and their carers, including information, advice and local activities.
            </p>
            <a href="https://www.ageuk.org.uk/walthamforest" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline font-bold">Visit Age UK Waltham Forest</a>
          </div>

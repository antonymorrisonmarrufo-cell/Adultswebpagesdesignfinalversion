  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">All-Age Carers strategy and council duties</h1>
        ...
        {activeTab === 'overview' && (
          <div className="prose max-w-none">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Overview</h2>
            ...
            <div className="bg-gray-50 border border-gray-200 p-6 mt-6">
              ...
              <p className="text-gray-700">
                <a href="#/adult-social-care/being-carer" className="text-[#D61F69] underline hover:no-underline font-bold">Visit the Being a carer section</a>
              </p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'information' && (
          <div className="prose max-w-none">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Information and support for carers</h2>
            <p className="text-gray-700 mb-4">
        ...
        {activeTab === 'duties' && (
          <div className="prose max-w-none">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Our duties towards carers</h2>
            <p className="text-gray-700 mb-4">
              Waltham Forest Council has legal duties to support carers under:
            </p>
            
            <h3 className="text-2xl font-bold text-[#D61F69] mb-3 mt-6">Care Act 2014</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-2xl font-bold text-[#D61F69] mb-3 mt-6">Children and Families Act 2014</h3>
            <p className="text-gray-700 mb-4">
        ...
        {activeTab === 'core-offer' && (
          <div className="prose max-w-none">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Our core offer to carers</h2>
            <p className="text-gray-700 mb-4">
              Waltham Forest's core offer to carers includes:
            </p>
            
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Information and advice</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Carer identification</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Assessment and support planning</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Practical and emotional support</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Financial support and guidance</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Involvement and co-production</h3>
              <p className="text-gray-700">
        ...
        {activeTab === 'contacts' && (
          <div className="prose max-w-none">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Useful contacts for carers</h2>
            
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Carers First Waltham Forest</h3>
              <p className="text-gray-700 mb-2">Main local support organization for unpaid carers</p>
              <p className="text-gray-700">
                <a href="https://www.carersfirst.org.uk" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline">Visit Carers First</a>
              </p>
            </div>

            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Adult Social Care</h3>
            ...
            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Young Carers Service</h3>
              <p className="text-gray-700 mb-2">Support for children and young people under 18 with caring responsibilities</p>
              <p className="text-gray-700">
                <a href="#/adult-social-care/being-carer/young-carers" className="text-[#D61F69] underline hover:no-underline">Find out more about young carers support</a>
              </p>
            </div>

            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Parent Carer Forum</h3>
              <p className="text-gray-700 mb-2">Parent-led group for parents and carers of disabled children</p>
              <p className="text-gray-700">
                <a href="#/adult-social-care/being-carer/parent-carers" className="text-[#D61F69] underline hover:no-underline">Find out more about parent carer support</a>
              </p>
            </div>

            <div className="bg-white border-2 border-gray-200 p-6 mb-4">
              <h3 className="text-xl font-bold text-[#D61F69] mb-3">Carers UK</h3>
              <p className="text-gray-700 mb-2">National charity providing information and support</p>
              <p className="text-gray-700">
                <a href="https://www.carersuk.org" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline">Visit Carers UK</a>
              </p>
            </div>
          </div>
        )}

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Work, education and training</h1>
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <ul className="space-y-2">
            <li><a href="#balancing" className="text-[#D61F69] underline hover:no-underline">Balancing work and caring</a></li>
            <li><a href="#flexible-working" className="text-[#D61F69] underline hover:no-underline">Flexible working and your rights</a></li>
            <li><a href="#returning" className="text-[#D61F69] underline hover:no-underline">Returning to work</a></li>
            <li><a href="#training" className="text-[#D61F69] underline hover:no-underline">Training and skills development</a></li>
            <li><a href="#financial-help" className="text-[#D61F69] underline hover:no-underline">Financial help while returning to work</a></li>
            <li><a href="#schemes" className="text-[#D61F69] underline hover:no-underline">Schemes and services that can help</a></li>
          </ul>
        </div>
        ...
        <div className="prose max-w-none">
          ...
          <div id="balancing" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Balancing work and caring</h2>
          ...
          <div id="flexible-working" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Flexible working and your rights</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700">
              <a href="https://www.gov.uk/flexible-working" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline font-bold">Find out more about flexible working on GOV.UK</a>
            </p>
          </div>

          <div id="returning" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Returning to work</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="training" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Training and skills development</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="financial-help" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Financial help while returning to work</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="schemes" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Schemes and services that can help</h2>
            <ul className="space-y-2">
              <li>
                <a href="https://www.carersfirst.org.uk" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline">Carers First – work and training support</a>
              </li>
              <li>
                <a href="https://www.gov.uk/jobsearch" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline">Find a job – GOV.UK</a>
              </li>
              <li>
                <a href="https://nationalcareers.service.gov.uk" target="_blank" rel="noopener noreferrer" className="text-[#D61F69] underline hover:no-underline">National Careers Service</a>
              </li>
              <li>
                <a href="#" className="text-[#D61F69] underline hover:no-underline">Waltham Forest adult learning and skills</a>
              </li>
            </ul>
          </div>

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl font-bold text-[#00635C] mb-4">Carer's assessment and your rights</h1>
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 mb-8">
          ...
          <ul className="space-y-2">
            <li><a href="#what-is" className="text-[#D61F69] underline hover:no-underline">What a carer's assessment is</a></li>
            <li><a href="#who-can-get" className="text-[#D61F69] underline hover:no-underline">Who can get one</a></li>
            <li><a href="#what-happens" className="text-[#D61F69] underline hover:no-underline">What happens in the assessment</a></li>
            <li><a href="#after-assessment" className="text-[#D61F69] underline hover:no-underline">What happens after the assessment</a></li>
            <li><a href="#your-rights" className="text-[#D61F69] underline hover:no-underline">Your rights as a carer</a></li>
        ...
        <div className="prose max-w-none">
          ...
          <div id="what-is" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">What a carer's assessment is</h2>
          ...
          <div id="who-can-get" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Who can get one</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="what-happens" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">What happens in the assessment</h2>
          ...
          <div id="after-assessment" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">What happens after the assessment</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="your-rights" className="mb-10">
            <h2 className="text-3xl font-bold text-[#D61F69] mb-4">Your rights as a carer</h2>
            <p className="text-gray-700 mb-4">
          ...
          <div id="related-help" className="mb-10">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#/adult-social-care/being-carer/support-for-carers" className="text-[#D61F69] underline hover:no-underline">Support for carers</a>
              </li>
              <li>
                <a href="#/adult-social-care/being-carer/support-for-carers/financial-support" className="text-[#D61F69] underline hover:no-underline">Financial support</a>
              </li>
              <li>
                <a href="#/adult-social-care/being-carer/support-for-carers/taking-a-break" className="text-[#D61F69] underline hover:no-underline">Taking a break from caring</a>
              </li>
              <li>
                <a href="#/adult-social-care/being-carer/work-education-and-training" className="text-[#D61F69] underline hover:no-underline">Work, education and training</a>
              </li>
            </ul>
          </div>

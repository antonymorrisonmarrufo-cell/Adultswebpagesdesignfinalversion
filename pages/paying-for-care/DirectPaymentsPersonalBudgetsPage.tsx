    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What is a personal budget?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How a personal budget can be managed</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What is a direct payment?</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Do I have to pay anything myself?</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What can I spend it on?</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What if I cannot manage it myself?</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What if I do not want a direct payment?</h2>
          <p className="text-gray-700">

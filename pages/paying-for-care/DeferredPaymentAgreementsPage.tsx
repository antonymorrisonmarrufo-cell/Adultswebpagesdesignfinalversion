    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What a deferred payment agreement is</h2>
        ...
        {/* Who is eligible */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Who is eligible</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">The 12-week property disregard</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How much you can defer</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What you pay from your income</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Interest */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Interest</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Set-up costs */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Set-up costs</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Rental income */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Rental income</h2>
          <p className="text-gray-700">
        ...
        {/* Top-up payments */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Top-up payments</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How the agreement ends</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What happens if your debt reaches the limit</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Your responsibilities</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Refusing or appealing a decision</h2>
          <p className="text-gray-700">
          ...
          <div className="bg-[#FFF4E6] border-l-4 border-[#D61F69] p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  See our page on <a href="#/adult-social-care/paying-for-care/get-financial-advice" className="text-[#D61F69] underline hover:no-underline">getting financial advice</a> for information about independent advisers, including the Society of Later Life Advisers (SOLLA) which specialises in care funding advice.
                </p>
              </div>
            </div>
          </div>

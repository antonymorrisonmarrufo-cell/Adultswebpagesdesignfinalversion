    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How we work out what you pay</h2>
        ...
        {/* When charges start */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">When charges start</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What you might need to pay</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What happens after your financial assessment</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">If you pay for your own care</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">If you own your home</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Charging policies */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Charging policies</h2>
          <p className="text-gray-700 mb-4">
          ...
          <div className="space-y-3">
            <a 
              ...
              className="flex items-center gap-2 text-[#D61F69] hover:underline"
            >
              <FileText size={18} />
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#/adult-social-care/paying-for-care/paying-for-a-care-home" className="text-[#D61F69] hover:underline">

    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">If you pay for your own care home</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What the council pays</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          ...
          {/* Important callout */}
          <div className="bg-gray-100 border-l-4 border-[#D61F69] p-6 mb-6">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Supporting downloads</h2>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#/adult-social-care/care-homes-and-supported-living" className="text-[#D61F69] hover:underline">

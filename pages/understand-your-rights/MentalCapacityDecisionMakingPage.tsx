    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">The right to make your own decisions</h2>
        ...
        {/* The five principles */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">The five principles</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What mental capacity means</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Best interests decisions</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Deprivation of Liberty Safeguards (DoLS)</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Lasting Power of Attorney</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Court of Protection</h2>
          <p className="text-gray-700 mb-4">

    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Your key rights</h2>
          <p className="text-gray-700 mb-4">Under the law, you have the right to:</p>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              <span className="text-[#D61F69] font-bold mt-1">•</span>
              <div>
        ...
        <section className="mb-12 bg-gray-50 border border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Need help understanding your rights?</h2>

    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Before you start</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What this form is for</h2>
        ...
        {/* What happens next */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What happens next</h2>

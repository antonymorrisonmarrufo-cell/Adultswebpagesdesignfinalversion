      ...
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <nav className="mb-10 bg-gray-50 p-6 border border-gray-200">
          ...
          <ul className="space-y-2">
            <li><a href="#what-it-is" className="text-[#D61F69] hover:underline">What sheltered housing is</a></li>
            <li><a href="#who-it-suits" className="text-[#D61F69] hover:underline">Who it may suit</a></li>
            <li><a href="#support-available" className="text-[#D61F69] hover:underline">What support is available</a></li>
            <li><a href="#types" className="text-[#D61F69] hover:underline">Types of sheltered housing</a></li>
        ...
        <section id="what-it-is" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What sheltered housing is</h2>
        ...
        <section id="support-available" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What support is available</h2>
        ...
        <section id="types" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Types of sheltered housing</h2>
        ...
        <section id="related" className="mb-10 scroll-mt-6">
          ...
          <div className="space-y-3">
            ...
            <a href="https://www.walthamforest.gov.uk/housing/find-home/social-housing/apply-join-housing-waiting-list-housing-register" target="_blank" rel="noopener noreferrer" className="block text-[#D61F69] hover:underline font-semibold">
              Apply to join the housing register
            </a>
          </div>
        </section>

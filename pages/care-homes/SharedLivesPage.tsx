      ...
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <nav className="mb-10 bg-gray-50 p-6 border border-gray-200">
          ...
          <ul className="space-y-2">
            <li><a href="#what-it-is" className="text-[#D61F69] hover:underline">What Shared Lives is</a></li>
            <li><a href="#who-it-suits" className="text-[#D61F69] hover:underline">Who it may suit</a></li>
            <li><a href="#daily-life" className="text-[#D61F69] hover:underline">What daily life can be like</a></li>
            <li><a href="#stays-respite" className="text-[#D61F69] hover:underline">Long stays, short breaks and respite</a></li>
            <li><a href="#paying" className="text-[#D61F69] hover:underline">Paying for Shared Lives</a></li>
            <li><a href="#how-to-get" className="text-[#D61F69] hover:underline">How to get Shared Lives</a></li>
        ...
        <section id="what-it-is" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What Shared Lives is</h2>
        ...
        <section id="daily-life" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">What daily life can be like</h2>
        ...
        <section id="stays-respite" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Long stays, short breaks and respite</h2>
        ...
        <section id="paying" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">Paying for Shared Lives</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section id="how-to-get" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-4">How to get Shared Lives</h2>
          ...
          <a
            href="#/adult-social-care/care-homes-and-supported-living/request-housing-care-support"
            className="inline-flex items-center gap-3 bg-[#D61F69] text-white px-8 py-3 text-sm font-semibold hover:bg-[#B51A5A] transition-colors mb-6 inline-block"
          >

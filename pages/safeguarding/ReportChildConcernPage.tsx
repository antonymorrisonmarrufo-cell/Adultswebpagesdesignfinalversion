  ...
  return (
    <>
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <h1 className="text-5xl text-[#00635C] mb-4 font-bold leading-tight">Report a concern about a child</h1>
        ...
        <div className="bg-[#FADADD] border-l-4 border-[#D61F69] px-6 py-5 mb-10 max-w-4xl">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1 text-gray-900 text-sm">
              ...
              <p>If you are worried about an adult, <a href="#/adult-social-care/protecting-adults-at-risk" className="text-[#D61F69] underline hover:no-underline">use the adult safeguarding route</a>.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {cards.map((card, i) => (
            <div key={i} className="bg-white border border-gray-200 p-6 pb-16 relative">
              ...
              <div className="absolute right-5 bottom-5 w-10 h-10 rounded-full bg-[#D61F69] flex items-center justify-center">

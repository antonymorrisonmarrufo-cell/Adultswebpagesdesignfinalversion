    ...
    <>
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="max-w-4xl space-y-0">
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What is MARAC?</h2>
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">What MARAC aims to do</h2>
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">MARAC referrals</h2>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-[#D61F69] text-white px-7 py-3 font-semibold hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
            >
          ...
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Practitioner support</h2>
            <p className="text-gray-700 mb-6">
            ...
            <div className="bg-gray-200 border border-gray-300 p-6 space-y-4">
              <div className="flex items-center gap-3 text-gray-700 text-sm">
                ...
                <span>
                  Telephone:{' '}
                  <a href="tel:07789480655" className="text-[#D61F69] underline hover:no-underline font-semibold">
                    07789 480 655
                  </a>
                </span>
              </div>
              <div className="flex items-center gap-3 text-gray-700 text-sm">
                ...
                <span>
                  Secure email:{' '}
                  <a href="mailto:JCMailbox-.MARAC@met.pnn.police.uk" className="text-[#D61F69] underline hover:no-underline font-semibold">

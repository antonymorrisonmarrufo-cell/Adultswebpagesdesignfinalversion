    ...
    <>
      <section className="bg-gray-200 py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Emergency Alert */}
          <div className="bg-[#FADADD] border-l-4 border-[#D61F69] px-6 py-5 mb-10 max-w-4xl">
            <div className="flex items-start gap-3">
              <Phone className="text-[#D61F69] flex-shrink-0 mt-0.5" size={20} />
              <div className="space-y-1 text-gray-900 text-sm">
                ...
                <p>
                  ...
                  <a href="#/children-and-families/report-concern-about-child" className="text-[#D61F69] underline hover:no-underline">
          ...
          <h2 className="text-[#D61F69] mb-8 font-bold text-xl">Choose what you need to do</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            ...
            <a
              ...
              className="group flex flex-col justify-between p-6 pb-20 relative border-2 border-[#D61F69] bg-[#FADADD] hover:shadow-lg transition-shadow focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
            >
              <div>
                <h3 className="mb-3 font-bold text-lg text-[#D61F69]">Report abuse or neglect</h3>
              ...
              <div className="absolute bottom-5 left-6 right-6 flex items-center justify-between">
                <span className="text-sm font-semibold text-[#D61F69]">Report a concern</span>
                <div className="w-10 h-10 rounded-full bg-[#D61F69] group-hover:bg-[#B51A5A] flex items-center justify-center flex-shrink-0 transition-colors">
            ...
            <div className="flex flex-col justify-between p-6 border-2 border-gray-200 bg-white">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-[#D61F69] text-white px-5 py-2.5 text-sm font-semibold hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 border-2 border-[#D61F69] text-[#D61F69] px-5 py-2.5 text-sm font-semibold hover:bg-[#D61F69] hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
                >
          ...
          <h2 className="text-[#D61F69] mb-6 font-bold text-xl">Related safeguarding information</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
            {relatedInfo.map((link, i) => (
              ...
              >
                ...
                <div className="w-8 h-8 rounded-full bg-[#D61F69] flex items-center justify-center flex-shrink-0 group-hover:bg-[#B51A5A] transition-colors">
          ...
          <div className="max-w-4xl mb-12">
            <h2 className="text-[#D61F69] mb-4 font-bold text-xl">Easy Read and accessible safeguarding information</h2>
            ...
            <div className="space-y-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-3 text-[#D61F69] hover:underline group"
              >

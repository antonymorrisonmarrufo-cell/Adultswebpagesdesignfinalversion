    ...
    <>
      <section className="bg-gray-200 py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Intro panel */}
          <div className="max-w-4xl bg-white border border-[#D61F69] px-6 py-4 mb-12">
          ...
          {/* Types of abuse */}
          <h2 className="text-[#D61F69] font-bold text-xl mb-6">Types of abuse and neglect</h2>
          ...
          <div className="max-w-4xl mb-12">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">When to report a concern</h2>
          ...
          <div className="max-w-4xl mb-14">
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#D61F69] text-white px-8 py-4 font-semibold hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
            >
              Report a concern
              <ArrowRight size={18} />
            </a>
          ...
          {/* Related links */}
          <h2 className="text-[#D61F69] mb-6 font-bold text-xl">Related information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {relatedLinks.map((link, i) => (
              <a
                key={i}
                href={link.href}
                className="bg-[#D61F69] text-white p-6 flex items-center justify-between hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
              >

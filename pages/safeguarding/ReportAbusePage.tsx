    ...
    <>
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="max-w-4xl space-y-12">
          ...
          <div>
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">If you are worried for yourself or someone you know</h2>
            ...
            <ul className="space-y-3 text-gray-700 mb-6">
              <li className="flex items-start gap-2">
                ...
                <span>
                  call{' '}
                  <a href="tel:02084963130" className="text-[#D61F69] underline hover:no-underline font-semibold">
                    020 8496 3130
                  </a>
                </span>
              </li>
            ...
            {/* Online CTA */}
            <div className="bg-[#FADADD] border-2 border-[#D61F69] p-8">
              <h3 className="text-[#D61F69] font-bold text-lg mb-3">Report online</h3>
          ...
          <div>
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">If you think a crime is being or has been committed</h2>
          ...
          <div>
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Forms and documents</h2>
          ...
          {/* Section: Quick guide */}
          <div>
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Quick guide</h2>
            <a
            ...
            >
              <FileText className="text-[#D61F69] flex-shrink-0" size={20} />
              <span className="text-gray-900 font-semibold text-sm group-hover:text-[#D61F69] transition-colors">
                Quick guide to adult safeguarding (PDF)
              </span>
              <ArrowRight className="text-[#D61F69] ml-auto" size={16} />
            </a>
          </div>

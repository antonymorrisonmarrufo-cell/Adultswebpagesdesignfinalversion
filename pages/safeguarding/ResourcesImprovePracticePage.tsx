      ...
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="max-w-4xl space-y-0">
          {resources.map((resource, i) => (
            <div key={i}>
              <div className="py-10">
                <h2 className="text-[#D61F69] font-bold text-xl mb-3">{resource.title}</h2>
                <p className="text-gray-700 mb-6">{resource.desc}</p>
                <a
                  href={resource.href}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#D61F69] text-white px-5 py-2.5 text-sm font-semibold hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
                >
        ...
        <div className="max-w-4xl mt-10 pt-10 border-t border-gray-200">
          <h2 className="text-[#D61F69] font-bold text-xl mb-6">Also useful</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <span className="text-gray-900 text-sm font-semibold group-hover:text-[#D61F69] transition-colors">

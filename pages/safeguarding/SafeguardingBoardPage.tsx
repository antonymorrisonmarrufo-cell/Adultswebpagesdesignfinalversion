      ...
      <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="mb-8">
          <a
            ...
            className="inline-flex items-center gap-2 text-[#D61F69] underline hover:no-underline text-sm font-semibold"
          >
        ...
        <div className="max-w-4xl space-y-0">
          ...
          <div className="py-6 space-y-3">
            {docs.map((doc, i) => (
              ...
              >
                ...
                <span className="text-gray-900 font-semibold text-sm group-hover:text-[#D61F69] transition-colors flex-1">
                  {doc.label}
                </span>
                <ArrowRight className="text-[#D61F69] flex-shrink-0" size={16} />
              </a>
            ))}
          </div>
          ...
          {/* Why the SAB exists */}
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Why the SAB exists</h2>
          ...
          {/* Contact */}
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-4">Contact the SAB</h2>
            ...
            <div className="flex items-center gap-3 text-gray-700 text-sm">
              ...
              <a
                ...
                className="text-[#D61F69] underline hover:no-underline font-semibold"
              >
          ...
          {/* Branch links */}
          <div className="py-10">
            <h2 className="text-[#D61F69] font-bold text-xl mb-6">SAB resources and guidance</h2>
              ...
              {branchLinks.map((link, i) => (
                ...
                >
                  <div className="flex items-start gap-3 flex-1">
                    {link.isPdf && <FileText className="text-[#D61F69] flex-shrink-0 mt-0.5" size={16} />}
                    <span className="text-gray-900 text-sm font-semibold leading-snug group-hover:text-[#D61F69] transition-colors">
                      {link.title}
                    </span>
                  </div>

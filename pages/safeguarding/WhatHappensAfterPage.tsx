    ...
    <>
      <section className="bg-gray-200 py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl space-y-0 mb-14">
            {sections.map((section, i) => (
              <div key={i} className={`py-8 bg-white px-8 border-x border-t border-gray-200 ${i === sections.length - 1 ? 'border-b shadow-sm' : ''}`}>
                <h2 className="text-[#D61F69] font-bold text-xl mb-3">{section.title}</h2>
          ...
          {/* CTA block */}
          <div className="max-w-4xl border-2 border-[#D61F69] bg-white p-8 mb-10 shadow-sm">
            <h2 className="text-[#D61F69] font-bold text-xl mb-3">Need to report a concern?</h2>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#D61F69] text-white px-8 py-3 font-semibold hover:bg-[#B51A5A] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D61F69]"
            >
              Report a concern
              <ArrowRight size={18} />
            </a>

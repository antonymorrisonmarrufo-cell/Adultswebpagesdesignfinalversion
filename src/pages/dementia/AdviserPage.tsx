export default function AdviserPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-5xl text-[#231F20] mb-6 font-bold leading-tight" id="top">Dementia Adviser (Alzheimer's Society)</h1>
      
      <p className="text-gray-700 max-w-4xl mb-12">
        One‑to‑one support if you have a diagnosis of dementia or you're being assessed.
      </p>

      <h2 className="text-[#bf3688] mb-8 font-bold" id="offer">What the service offers</h2>
      ...
      <div className="text-gray-700 max-w-4xl">
        <p className="mb-4">
          <strong>Contact (Waltham Forest):</strong> 020 8556 8171 • <a href="mailto:walthamforest@alzheimers.org.uk" className="text-[#bf3688] hover:underline">walthamforest@alzheimers.org.uk</a>
        </p>
        <p>

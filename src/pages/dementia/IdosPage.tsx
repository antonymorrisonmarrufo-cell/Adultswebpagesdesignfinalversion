export default function IdosPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-5xl text-[#231F20] mb-6 font-bold leading-tight" id="top">Intensive Dementia Outreach Service (IDOS)</h1>
      ...
      <h2 className="text-[#bf3688] mb-8 font-bold" id="what">What IDOS does</h2>
      ...
      <h2 className="text-[#bf3688] mb-8 font-bold" id="contact">Address and contact</h2>
      ...
      <h2 className="text-[#bf3688] mb-8 font-bold" id="refer">Who can refer</h2>
      <p className="text-gray-700 max-w-4xl mb-12">
        Memory Service clinicians, GPs, Adult Social Care or the <a href="#/adult-social-care/specialist-services/dementia/hub" className="text-[#bf3688] hover:underline">Dementia Hub</a> can help you access IDOS.
      </p>

      <h2 className="text-[#bf3688] mb-8 font-bold" id="satisfaction">Satisfaction</h2>

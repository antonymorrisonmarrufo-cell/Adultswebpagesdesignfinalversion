    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-wf-gray-light">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <h1 className="text-5xl font-bold text-[#00635C]">Support for carers</h1>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69] mb-6">Types of support available</h2>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            >
              <h3 className="text-lg font-bold text-[#00635C]">Financial support</h3>
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Taking a break from caring</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Carer emergency plan</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Health and wellbeing</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Local groups and services</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Training and workshops</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Carers feedback</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Useful contacts</h3>
              <p className="mt-2 text-sm text-wf-gray">
        ...
        <section className="mb-8 rounded-md border-l-4 border-[#00635C] bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-[#D61F69]">Need help finding the right support?</h2>

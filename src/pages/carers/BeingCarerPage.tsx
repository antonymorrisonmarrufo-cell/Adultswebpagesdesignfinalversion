    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-wf-gray-light">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <h1 className="text-5xl font-bold text-[#00635C]">Being a carer</h1>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <section className="mb-8 rounded-md bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-[#D61F69]">Are you a carer?</h2>
        ...
        <section className="mb-8">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Young carers</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Parent carers</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Work and education</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Carers strategy and council duties</h3>
              <p className="mt-2 text-sm text-wf-gray">
            ...
            <Link
              ...
              className="block rounded-md bg-white p-6 shadow-sm border border-wf-gray-light hover:border-wf-green hover:shadow-md transition-all no-underline"
            >
              <h3 className="text-lg font-bold text-[#00635C]">Information and advice flow</h3>
              <p className="mt-2 text-sm text-wf-gray">
        ...
        <section className="mb-8 rounded-md border-l-4 border-[#00635C] bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-[#D61F69]">Contact us</h2>
          <p className="mt-3 text-wf-dark leading-relaxed">

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-wf-gray-light">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <h1 className="text-5xl font-bold text-[#00635C]">Money and benefits for carers</h1>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <section className="mb-8 rounded-md bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-[#D61F69]">Benefits you may be entitled to</h2>
          <div className="mt-4 space-y-4">
            <div className="rounded-md border border-wf-gray-light p-4">
              <h3 className="text-lg font-bold text-[#00635C]">Carer's Allowance</h3>
            ...
            <div className="rounded-md border border-wf-gray-light p-4">
              <h3 className="text-lg font-bold text-[#00635C]">Carer's Credit</h3>
              <p className="mt-2 text-wf-dark">
            ...
            <div className="rounded-md border border-wf-gray-light p-4">
              <h3 className="text-lg font-bold text-[#00635C]">Universal Credit carer element</h3>
              <p className="mt-2 text-wf-dark">
            ...
            <div className="rounded-md border border-wf-gray-light p-4">
              <h3 className="text-lg font-bold text-[#00635C]">Council tax reduction</h3>
              <p className="mt-2 text-wf-dark">
                You may be entitled to a discount or exemption from council tax, depending on your circumstances.
              </p>
            </div>
            <div className="rounded-md border border-wf-gray-light p-4">
              <h3 className="text-lg font-bold text-[#00635C]">Direct payments</h3>
              <p className="mt-2 text-wf-dark">
        ...
        {/* Grants */}
        <section className="mb-8 rounded-md bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-[#D61F69]">Grants and one-off help</h2>
        ...
        <section className="mb-8 rounded-md border-l-4 border-[#00635C] bg-white p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-[#D61F69]">Get free benefits advice</h2>

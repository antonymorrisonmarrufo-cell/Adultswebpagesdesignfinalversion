    ...
    <div className="min-h-screen">
      ...
      <div className="bg-white">
        <div className="max-w-5xl mx-auto px-4 pt-6 pb-8">
          ...
          <h1 className="text-5xl font-bold text-[#231F20]">Financial support for carers</h1>
      ...
      <div className="bg-[#f3f2f1]">
        <div className="max-w-5xl mx-auto px-4 py-10">
          ...
          <h2 className="text-2xl font-bold text-[#003078]">Get benefits advice</h2>
          <p className="mt-3 text-wf-dark leading-relaxed">
          ...
          <li>
          <Link to="/adult-social-care/being-carer/tasks/money-benefits" className="text-wf-blue underline hover:text-wf-green">

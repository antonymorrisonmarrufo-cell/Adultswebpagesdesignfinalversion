    ...
    <div className="min-h-screen">
      ...
      <div className="bg-white">
        <div className="max-w-5xl mx-auto px-4 pt-6 pb-8">
          ...
          <h1 className="text-5xl font-bold text-[#231F20]">Useful contacts for carers</h1>
      ...
      <div className="bg-[#f3f2f1]">
        <div className="max-w-5xl mx-auto px-4 py-10">
          ...
          <h3 className="text-lg font-bold text-[#231F20]">Waltham Forest Adult Social Care</h3>
          ...
          <div className="border-b border-wf-gray-light pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Carers First (Waltham Forest)</h3>
          ...
          <div className="border-b border-wf-gray-light pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Citizens Advice Waltham Forest</h3>
          ...
          <div className="border-b border-wf-gray-light pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Age UK Waltham Forest</h3>
          ...
          <div className="pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Mind in Waltham Forest</h3>
          ...
          <div className="mt-4 space-y-4">
          <div className="border-b border-wf-gray-light pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Carers UK helpline</h3>
          ...
          <div className="border-b border-wf-gray-light pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Carers Trust</h3>
          ...
          <div className="border-b border-wf-gray-light pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Samaritans</h3>
          ...
          <div className="border-b border-wf-gray-light pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">Alzheimer's Society</h3>
          ...
          <div className="pb-4">
          <h3 className="text-lg font-bold text-[#231F20]">NHS 111</h3>

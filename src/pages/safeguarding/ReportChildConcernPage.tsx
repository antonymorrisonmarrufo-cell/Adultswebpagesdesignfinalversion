    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-wf-gray-light">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <h1 className="text-5xl font-bold text-[#00635C]">Reporting concerns about a child</h1>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mb-8 rounded-md border-l-4 border-wf-red bg-red-50 p-6">
          <h2 className="text-2xl font-bold text-[#D61F69]">If a child is in immediate danger</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69]">Children's safeguarding is a separate process</h2>
        ...
        {/* How to report */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69]">How to report concerns about a child</h2>

          <div className="mt-6 space-y-4">
            <div className="rounded-md border border-wf-gray-light p-6">
              <h3 className="text-lg font-bold text-[#00635C]">Contact the MASH team</h3>
              <p className="mt-2 text-wf-dark">
                If you are worried about a child, contact the Waltham Forest MASH:
              </p>
              <p className="mt-3 text-2xl font-bold text-[#00635C]">
                <a href="tel:02084962310" className="no-underline text-[#00635C]">020 8496 2310</a>
              </p>
            ...
            <div className="rounded-md border border-wf-gray-light p-6">
              <h3 className="text-lg font-bold text-[#00635C]">Online referral</h3>
              <p className="mt-2 text-wf-dark">
        ...
        {/* What to report */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69]">What should you report?</h2>
          <p className="mt-3 text-wf-dark leading-relaxed">
        ...
        <section className="mb-8 rounded-md border border-wf-gray-light bg-wf-gray-light p-6">
          <h2 className="text-2xl font-bold text-[#D61F69]">Other useful contacts</h2>
          <ul className="mt-4 space-y-4 text-wf-dark">
            <li>
              <strong>NSPCC Helpline:</strong>{" "}
              <a href="tel:08088005000" className="font-bold text-[#00635C] no-underline">0808 800 5000</a>
              <br />
              <span className="text-sm text-wf-gray">For adults concerned about a child. Available 24/7.</span>
            </li>
            <li>
              <strong>Childline:</strong>{" "}
              <a href="tel:08001111" className="font-bold text-[#00635C] no-underline">0800 1111</a>
              <br />
            ...
            <li>
              ...
              <a href="tel:101" className="font-bold text-[#00635C] no-underline">101</a>
              <br />

              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Support for you</h3>
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Support for your family</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Day opportunities</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Health and therapy support</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Equipment and adaptations</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Future planning</h3>
                    <p className="text-gray-700 text-sm">

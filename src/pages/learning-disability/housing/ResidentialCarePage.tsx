        ...
        <section className="max-w-7xl mx-auto px-6 py-8 md:py-12">
          ...
          <div className="bg-white border border-gray-300 p-8 md:p-12 shadow-sm max-w-4xl">
            ...
            <div className="max-w-3xl space-y-12">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">24-hour care and support</h3>
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Meals and nutrition</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Health care coordination</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Activities and engagement</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white border border-gray-200 p-6 shadow-sm">
                    <h3 className="text-[#bf3688] font-bold text-lg mb-2">Specialist support</h3>
                    <p className="text-gray-700 text-sm">
              ...
              {/* Paying for care */}
              <section>
                <h2 className="text-[#bf3688] font-bold text-2xl mb-6">Paying for care</h2>

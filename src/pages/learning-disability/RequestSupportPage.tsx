...
export default function RequestSupportPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <button
      type="submit"
      className="rounded-md bg-[#bf3688] px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#a02d73] focus:outline-none focus:ring-2 focus:ring-[#bf3688] focus:ring-offset-2"
      >
      Submit request
      </button>
      </form>

      ...
      <div className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-12 bg-gray-200 p-8 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Urgent mental health support</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Looking after your mental wellbeing</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Talking therapies and professional support</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Adult social care and mental health</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Local mental health support services</h3>

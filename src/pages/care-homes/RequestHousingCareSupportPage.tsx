      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <section className="mb-8 rounded-md bg-white p-6 shadow-sm">
          ...
          <ul className="mt-4 space-y-3">
            <li>
              <Link to="/adult-social-care/housing-and-care-homes" className="text-wf-blue underline hover:text-wf-green">
                Housing and care homes
              </Link>
            </li>
            <li>
              <Link to="/adult-social-care/housing-and-care-homes/supported-living" className="text-wf-blue underline hover:text-wf-green">
                Supported living
              </Link>
            </li>
            <li>

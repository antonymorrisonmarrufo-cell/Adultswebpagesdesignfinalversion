    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <div className="mb-12 border-2 border-gray-200 bg-gray-50 h-96 flex items-center justify-center">
          <img src="/Images/care-homes-hub.jpg" alt="Care Homes and Supported Living Hub" className="w-full h-full object-cover" />
        </div>

        {/* How the main options compare */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#bf3688] mb-6">How the main options compare</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative">
              <h3 className="text-lg font-bold text-[#bf3688] mb-3 pr-12">Supported living</h3>
              ...
              <a
                ...
                className="absolute right-6 bottom-6 w-10 h-10 rounded-full bg-[#bf3688] flex items-center justify-center hover:bg-[#a02d73] transition-colors"
              >
            ...
            {/* Shared Lives */}
            <div className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative">
              <h3 className="text-lg font-bold text-[#bf3688] mb-3 pr-12">Shared Lives</h3>
              <p className="text-gray-700 text-sm mb-4 pr-12">
            ...
            {/* Extra care housing */}
            <div className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative">
              <h3 className="text-lg font-bold text-[#bf3688] mb-3 pr-12">Extra care housing</h3>
              <p className="text-gray-700 text-sm mb-4 pr-12">
            ...
            {/* Sheltered housing */}
            <div className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative">
              <h3 className="text-lg font-bold text-[#bf3688] mb-3 pr-12">Sheltered housing</h3>
              <p className="text-gray-700 text-sm mb-4 pr-12">
            ...
            <div className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative">
              <h3 className="text-lg font-bold text-[#bf3688] mb-3 pr-12">Care homes and nursing homes</h3>
              <p className="text-gray-700 text-sm mb-4 pr-12">
        ...
        <section className="mb-12 bg-gray-200 p-8 border border-gray-200">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-6">Not sure which option is right?</h2>
          <p className="text-gray-700 mb-6">These options suit different levels of support.</p>
          
          <div className="space-y-4">
            <div className="bg-white p-4 border-2 border-[#003078] bg-[#d7f8ff]">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#bf3688] mb-6">How to get housing and care support</h2>
        ...
        <section className="mb-12 bg-gray-200 p-8 border border-gray-200">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Paying for care and accommodation</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Paying for care and support</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Financial Assessment </h3>
              <div className="absolute right-6 bottom-6 w-10 h-10 rounded-full bg-[#bf3688] flex items-center justify-center">
                <ArrowRight className="text-white" size={20} />
              </div>
            </a>
        ...
        {/* Related support */}
        <section className="mb-12 bg-gray-200 p-8 border border-gray-200">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-6">Related support</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">New to care and support</h3>
              <div className="absolute right-6 bottom-6 w-10 h-10 rounded-full bg-[#bf3688] flex items-center justify-center">
                <ArrowRight className="text-white" size={20} />
              </div>
            </a>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Who qualifies for social care support</h3>
              <div className="absolute right-6 bottom-6 w-10 h-10 rounded-full bg-[#bf3688] flex items-center justify-center">
                <ArrowRight className="text-white" size={20} />
              </div>
            </a>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Care and support plans</h3>
              <div className="absolute right-6 bottom-6 w-10 h-10 rounded-full bg-[#bf3688] flex items-center justify-center">
                <ArrowRight className="text-white" size={20} />
              </div>
            </a>

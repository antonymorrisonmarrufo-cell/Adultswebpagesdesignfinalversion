      ...
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <nav className="mb-10 bg-gray-50 p-6 border border-gray-200">
          ...
          <ul className="space-y-2">
            <li><a href="#what-it-is" className="text-[#bf3688] hover:underline">What supported living is</a></li>
            <li><a href="#who-it-suits" className="text-[#bf3688] hover:underline">Who it may suit</a></li>
            <li><a href="#support-available" className="text-[#bf3688] hover:underline">What support you can get</a></li>
            <li><a href="#your-home" className="text-[#bf3688] hover:underline">What your home may be like</a></li>
            <li><a href="#how-to-get" className="text-[#bf3688] hover:underline">How to get supported living</a></li>
            <li><a href="#paying" className="text-[#bf3688] hover:underline">Paying for supported living</a></li>
        ...
        <section id="what-it-is" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">What supported living is</h2>
        ...
        <section id="support-available" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">What support you can get</h2>
        ...
        <section id="your-home" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">What your home may be like</h2>
        ...
        <section id="how-to-get" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">How to get supported living</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section id="paying" className="mb-10 scroll-mt-6">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Paying for supported living</h2>
          <p className="text-gray-700 mb-4">

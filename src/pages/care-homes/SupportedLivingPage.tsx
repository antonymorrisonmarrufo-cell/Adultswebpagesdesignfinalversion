    ...
    <div className="min-h-screen">
      ...
      <div className="bg-[#f3f2f1]">
        <div className="max-w-5xl mx-auto px-4 py-10">
          ...
          <li>
          <Link to="/adult-social-care/care-homes-and-supported-living/shared-lives" className="text-wf-blue underline hover:text-wf-green">
          Shared Lives
          </Link>
          </li>
          <li>
          <Link to="/adult-social-care/care-homes-and-supported-living/extra-care-housing" className="text-wf-blue underline hover:text-wf-green">
          Extra care housing
          </Link>
          </li>
          <li>

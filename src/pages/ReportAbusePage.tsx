    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-wf-gray-light">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <h1 className="text-5xl font-bold text-[#00635C]">Report abuse</h1>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mb-8 rounded-md border-l-4 border-wf-red bg-red-50 p-6">
          <h2 className="text-2xl font-bold text-[#D61F69]">If someone is in immediate danger</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69]">Report a safeguarding concern</h2>
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            {/* Phone */}
            <div className="rounded-md border-2 border-[#00635C] p-6">
              <h3 className="text-lg font-bold text-[#00635C]">Call us</h3>
              <p className="mt-2 text-wf-dark">
                Speak to our Adult Social Care team about your concern:
              </p>
              <p className="mt-3 text-3xl font-bold text-[#00635C]">
              ...
              <div className="mt-4 border-t border-wf-gray-light pt-4">
                ...
                <p className="text-lg font-bold text-[#00635C] mt-1">
            ...
            {/* Online form */}
            <div className="rounded-md border-2 border-[#00635C] p-6">
              <h3 className="text-lg font-bold text-[#00635C]">Report online</h3>
              <p className="mt-2 text-wf-dark">
        ...
        {/* What is abuse */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69]">What counts as abuse?</h2>
        ...
        {/* Who can report */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69]">Anyone can report</h2>
          <p className="mt-3 text-wf-dark leading-relaxed">
        ...
        <section className="mb-8 rounded-md border border-wf-gray-light bg-wf-gray-light p-6">
          <h2 className="text-2xl font-bold text-[#D61F69]">Concerned about a child?</h2>
          <p className="mt-3 text-wf-dark leading-relaxed">
        ...
        {/* More information */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#D61F69]">More information</h2>

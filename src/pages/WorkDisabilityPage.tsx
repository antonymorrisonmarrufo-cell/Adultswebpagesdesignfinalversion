export default function WorkDisabilityPage() {
  return (
    <div className="min-h-screen bg-gray-200">
      ...
      <h1 className="text-5xl text-[#231F20] mb-6 font-bold leading-tight" id="top">Work and disability</h1>
      
      <p className="text-gray-700 max-w-4xl mb-12">
        Guidance, training and local support to get into work, stay in work and progress.
      </p>

      <h2 className="text-[#bf3688] mb-8 font-bold" id="expect">What you can expect</h2>
      ...
      <h2 className="text-[#bf3688] mb-8 font-bold" id="start">Get started</h2>

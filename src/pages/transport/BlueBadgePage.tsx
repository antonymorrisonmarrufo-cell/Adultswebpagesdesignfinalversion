          ...
          <div className="flex flex-col lg:flex-row gap-10 mt-10">
            ...
            <div className="flex-1 max-w-3xl space-y-0">
              ...
              <div id="eligibility" className="scroll-mt-6 pb-10">
                <h2 className="text-[#bf3688] font-bold text-2xl mb-4">Are you eligible for a Blue Badge?</h2>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-[#bf3688] underline hover:no-underline text-sm font-bold"
                >
              ...
              <div id="apply" className="scroll-mt-6 py-10">
                <h2 className="text-[#bf3688] font-bold text-2xl mb-4">Apply or renew a Blue Badge</h2>
              ...
              <div id="using" className="scroll-mt-6 py-10">
                <h2 className="text-[#bf3688] font-bold text-2xl mb-4">Using your Blue Badge</h2>
              ...
              <div id="replace" className="scroll-mt-6 py-10">
                <h2 className="text-[#bf3688] font-bold text-2xl mb-4">Replace a lost, stolen or damaged badge</h2>
              ...
              <div id="appeal" className="scroll-mt-6 py-10">
                <h2 className="text-[#bf3688] font-bold text-2xl mb-4">Appeal a Blue Badge decision</h2>
                <p className="text-gray-700 leading-relaxed">

    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Why advice matters</h2>
        ...
        {/* Finding an adviser */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Finding an adviser</h2>
          <p className="text-gray-700 mb-4">
            ...
            <li className="flex gap-2 items-start">
              ...
              <div>
                <a 
                  ...
                  className="text-[#bf3688] hover:underline font-bold"
                >
                  FCA Register
                </a>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Free advice and support</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">If you are worried about debt</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Planning ahead</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="https://www.walthamforest.gov.uk/housing-and-homes/money-advice-benefits-debt-and-budgeting" target="_blank" rel="noopener noreferrer" className="text-[#bf3688] hover:underline">

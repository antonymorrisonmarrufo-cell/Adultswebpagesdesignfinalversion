    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-[#bf3688] mb-6">How the process works</h2>
        ...
        <section className="mb-12 bg-gray-200 p-8 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">How care costs are worked out</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Benefits and help with costs</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Direct payments and personal budgets</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Paying for a care home</h3>
            ...
            <a
              ...
              className="bg-white border border-gray-200 shadow-sm p-6 pb-20 hover:shadow-md transition-shadow relative block"
            >
              <h3 className="text-lg font-bold text-[#bf3688] mb-2 pr-12">Get financial advice</h3>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="https://www.walthamforest.gov.uk/adult-social-care/get-social-care-help/who-qualifies-social-care-support" target="_blank" rel="noopener noreferrer" className="text-[#bf3688] hover:underline">

  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <h1 className="text-5xl text-[#231F20] mb-6 font-bold leading-tight" id="top">Physical disabilities</h1>
        ...
        <div className="bg-white border border-gray-300 p-8 mb-12 shadow-sm max-w-4xl">
          <h2 className="text-[#bf3688] mb-8 font-bold text-2xl" id="offer">What we can help with</h2>
        ...
        <div className="bg-white border border-gray-300 p-8 mb-12 shadow-sm max-w-4xl">
          <h2 className="text-[#bf3688] mb-8 font-bold text-2xl" id="get-help">How to get help</h2>
        ...
        <h2 className="text-[#bf3688] mb-8 font-bold text-2xl">Related</h2>
        <p className="text-gray-700 max-w-4xl">
          See <a href="#/adult-social-care/work-and-disability" className="text-[#bf3688] font-bold hover:underline">Work and disability</a> for employment support.
        </p>
      </div>
    </div>
  );

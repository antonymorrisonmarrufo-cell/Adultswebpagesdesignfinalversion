    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Talk to your social worker or care coordinator first</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Challenging a care needs assessment decision</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Challenging a financial assessment</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Challenging a care and support plan</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Making a formal complaint</h2>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700">
            See our <a href="#/adult-social-care/complaints-compliments/make-a-complaint" className="text-[#bf3688] underline hover:no-underline">complaints page</a> for how to submit a complaint.
          </p>
        </section>

        {/* The Local Government and Social Care Ombudsman */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">The Local Government and Social Care Ombudsman</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Judicial review */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Judicial review</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Getting independent help</h2>
          <p className="text-gray-700 mb-4">

    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">The right to an assessment</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">The right to be involved</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">The right to information and advice</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">The right to choice and control</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">The right to continuity of care</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">The right to safeguarding</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Services that must be free</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#bf3688] mb-4">Where to find the Care Act</h2>
          <p className="text-gray-700 mb-4">

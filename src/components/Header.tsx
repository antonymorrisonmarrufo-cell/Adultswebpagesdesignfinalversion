      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
        <div className="flex items-center gap-3">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 8C24 8 18 12 18 17C18 20 20 21.5 21.5 22.5C18.5 22.5 16 24 16 27C16 29.5 17.5 31 19 32C16.5 32 14 33.5 14 36C14 38.5 16 40 17.5 41C15 41 12.5 42.5 12.5 45C12.5 47.5 15 49 18 49H30C33 49 35.5 47.5 35.5 45C35.5 42.5 33 41 30.5 41C32 40 33.5 38.5 33.5 36C33.5 33.5 31 32 28.5 32C30 31 31.5 29.5 31.5 27C31.5 24 29 22.5 26 22.5C27.5 21.5 29 20 29 17C29 12 24 8 24 8Z" fill="#004E3E"/>
          </svg>
          <div>
